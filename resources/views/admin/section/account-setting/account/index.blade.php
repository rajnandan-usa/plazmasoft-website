                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="{{asset('admin/img/avatars/5.png')}}" alt="user-avatar" class="d-block rounded" height="100"
                            ...
                            <div class="button-wrapper">
                                ...
                                <p class="text-muted mb-0 small">Allowed JPG, GIF or PNG. Max size of 800K</p>
                            </div>
                        </div>
                    </div>
                    <hr class="my-0" />
