                            ...
                            <div class="row">
                                        ...
                                        <div class="col-10">
                                            ...
                                            <div class="col-12" id="bannerUrlBox" style="display: none">
                                                ...
                                                <input type="url" class="form-control" id="bannerUrl" name="bannerUrl"
                                                    value="{{ old('bannerUrl', str_starts_with($project->banner, 'http') ? $project->banner : null) }}"
                                        ...
                                        <div class="col-10">
                                            ...
                                            <div class="col-12" id="logoUrlBox" style="display: none">
                                                ...
                                                <input type="url" class="form-control" id="logoUrl" name="logoUrl"
                                                    value="{{ old('logoUrl', str_starts_with($project->logo, 'http') ? $project->logo : null) }}"
                                                    placeholder="Enter logo URL ">
                                                <x-input-error :messages="$errors->get('logoUrl')" class="mt-2" />
                                            </div>
                                            @if ($project->logo)
                                                <img height="100px" width="auto" class="mx-auto my-2 rounded shadow"
                                                    src="{{ str_starts_with($project->logo, 'http') ? $project->logo : asset('/storage/' . $project->logo) }}"
                                                    alt="logo Image">
                                            @endif
                                        </div>
                                        <div class="col-2">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="category" name="category"
                                        placeholder="Enter project category" required
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="shortDescription"
                                        ...
                                        value="{{ old('shortDescription', $project->shortDescription) }}">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <textarea class="d-none form-control" id="content" name="description"
                                        placeholder="Enter full project description">{{ old('description', $project->description) }}</textarea>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="country" name="country"
                                        placeholder="Enter country" value="{{ old('country', $project->country) }}">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select id="status" class="form-select" required name="status">
                                        <option value="draft"
                                            {{ old('status', $project->status) === 'draft' ? 'selected' : '' }}>Draft
                                        </option>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="date" class="form-control" id="startDate" name="startDate"
                                        value="{{ old('startDate', $project->startDate) }}">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="date" class="form-control" id="endDate" name="endDate"
                                        value="{{ old('endDate', $project->endDate) }}">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="url" class="form-control" id="videoUrl" name="videoUrl"
                                        placeholder="Enter video URL" value="{{ old('videoUrl', $project->videoUrl) }}">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="clientName" name="clientName"
                                        ...
                                        value="{{ old('clientName', $project->clientName) }}">
                                    ...
                                    <div class="row justify-content-center align-items-center">
                                        <div class="col-10">
                                            ...
                                            <div class="col-12" id="clientAvatarUrlBox" style="display: none">
                                                <label class="form-label" for="clientAvatarUrl">clientAvatar URL</label>

                                                <input type="url" class="form-control" id="clientAvatarUrl"
                                                    name="clientAvatarUrl"
                                                    value="{{ old('clientAvatarUrl', str_starts_with($project->clientAvatar, 'http') ? $project->clientAvatar : null) }}"
                                                    placeholder="Enter clientAvatar URL ">
                                                <x-input-error :messages="$errors->get('clientAvatarUrl')" class="mt-2" />
                                            </div>

                                            @if ($project->clientAvatar)
                                                <img height="100px" width="auto" class="mx-auto my-2 rounded shadow"
                                                    src="{{ str_starts_with($project->clientAvatar, 'http') ? $project->clientAvatar : asset('/storage/' . $project->clientAvatar) }}"
                                                    alt="Client Avatar">
                                            @endif
                                        </div>
                                        <div class="col-2">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <textarea class="form-control" id="clientFeedback" name="clientFeedback"
                                        placeholder="Enter feedback from the client">{{ old('clientFeedback', $project->clientFeedback) }}</textarea>
