                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item vs-has-submenu">
                            ...
                            <ul class="vs-mega-menu-list vs-hire-developers-menu">
                                <li class="vs-mega-menu-item">
                                    <a href="{{ route('team.flutter_developer') }}" class="vs-mega-menu-link">
                                        <span class="vs-mega-menu-icon">
                                            <img src="{{asset('web-assets/images/flutter.svg')}}" width="25" height="25" alt="flutter"
                                                class="img-fluid">
                                        </span>
                                        <span class="vs-mega-menu-details">
                                            <h3 class="vs-mega-menu-title">Flutter Developer</h3>
                                            <p class="vs-mega-menu-description">Our Flutter developers excel in
                                                creating seamless and engaging user experiences.</p>
                                        </span>
                                    </a>
                                </li>
                                <li class="vs-mega-menu-item">
                                    <a href="{{ route('team.reactjs_developer') }}" class="vs-mega-menu-link">
                                        <span class="vs-mega-menu-icon">
                                            <img src="{{asset('web-assets/images/atom.png')}}" width="25" height="25" alt="react-icon"
                                                class="img-fluid">
                                        </span>
                                        <span class="vs-mega-menu-details">
                                            <h3 class="vs-mega-menu-title">ReactJS Developer</h3>
                                            <p class="vs-mega-menu-description">TechnoYuga ReactJS developers are
                                                proficient in creating interactive user interfaces and user
                                                satisfaction.</p>
                                        </span>
                                    </a>
                                </li>
                                <li class="vs-mega-menu-item">
                                    <a href="{{ route('team.fullstack_developer') }}" class="vs-mega-menu-link">
                                        <span class="vs-mega-menu-icon">
                                            <img src="{{asset('web-assets/images/thorough.png')}}" width="25" height="25" alt="full-stack-icon"
                                                class="img-fluid">
                                        </span>
                                        <span class="vs-mega-menu-details">
                                            <h3 class="vs-mega-menu-title">Full Stack Developer</h3>
                                            <p class="vs-mega-menu-description">Our Full Stack developers bring
                                                efficiency and expertise to your project, ensuring a seamless
                                                experience.</p>
                                        </span>
                                    </a>
                                </li>
                                <li class="vs-mega-menu-item">
                                    <a href="{{ route('team.mernstack_developer') }}" class="vs-mega-menu-link">
                                        <span class="vs-mega-menu-icon">
                                            <img src="{{asset('web-assets/images/Mern-stack-development.png')}}" width="25" height="25" alt="mern-icon"
                                                class="img-fluid">
                                        </span>
                                        <span class="vs-mega-menu-details">
                                            <h3 class="vs-mega-menu-title">MERN Stack Developer</h3>
                                            <p class="vs-mega-menu-description">Explore our MERN Stack developers
                                                skilled in utilizing MongoDB, React, and Node.js. to build robust
                                                web apps.</p>
                                        </span>
                                    </a>
                                </li>
                                <li class="vs-mega-menu-item">
                                    <a href="{{ route('team.reactnative_developer') }}" class="vs-mega-menu-link">
                                        <span class="vs-mega-menu-icon">
                                            <img src="{{asset('web-assets/images/physics.png')}}" width="25" height="25" alt="react-icon"
                                                class="img-fluid">
                                        </span>
                                        <span class="vs-mega-menu-details">
                                            <h3 class="vs-mega-menu-title">React Native Developer</h3>
                                            <p class="vs-mega-menu-description">Find top-notch React Native
                                                developers proficient in building high-quality mobile apps for both
                                                platforms.</p>
                                        </span>
                                    </a>
                                </li>
                                <li class="vs-mega-menu-item">
                                    <a href="{{ route('team.dedicated_developer') }}" class="vs-mega-menu-link">
                                        <span class="vs-mega-menu-icon">
                                            <img src="{{asset('web-assets/images/data.png')}}"  width="25" height="25" alt="react-icon"
                                                class="img-fluid">
                                        </span>
                                        <span class="vs-mega-menu-details">
                                            <h3 class="vs-mega-menu-title">Dedicated Developer</h3>
                                            <p class="vs-mega-menu-description">Find top-notch dedicated developers
                                                proficient in building high-quality apps for any platforms.</p>
                                        </span>
                                    </a>
                                </li>
                            </ul>
