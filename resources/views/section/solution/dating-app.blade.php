                    ...
                    <div class="vs-landing-form">
                        ...
                        <div class="vs-landing-form__inner">
                            <form class="row g-3" id="solution-form">
                                <input type="hidden" name="_token" value="tFuvSsnXOGJ3QrQZS8JZ0YKYTMaOYVP0YyABtAj2">                                    <input type="hidden" name="solution_criteria" value="Dating App" />
            ...
            <div class="vs-service-content mb-0">
                <div class="row">
                    <div class="col col-12 col-md-6 col-lg-4">
                        <div class="vs-service-card">
                            <a class="vs-service-card-link">
                                <h3 class="vs-service-card-title">Dating App<br/>Consulting Services</h3>
                                <div class="vs-service-card-logo-list">
                                    <div class="vs-service-card-logo-item">
                                        <img src="{{asset('web-assets/images/dating-icon.svg')}}" alt="money-transfer"
                                            class="img-fluid">
                                    </div>
                                </div>
                    ...
                    <div class="col col-12 col-md-6 col-lg-4">
                        <div class="vs-service-card">
                            <a class="vs-service-card-link">
                                <h3 class="vs-service-card-title">Custom Dating <br/> App Development</h3>
                                <div class="vs-service-card-logo-list">
                                    <div class="vs-service-card-logo-item">
                    ...
                    <div class="col col-12 col-md-6 col-lg-4">
                        <div class="vs-service-card">
                            <a class="vs-service-card-link">
                                <h3 class="vs-service-card-title">Dating <br/> App UX/UI</h3>
                                <div class="vs-service-card-logo-list">
                                    <div class="vs-service-card-logo-item">
                    ...
                    <div class="col col-12 col-md-6 col-lg-4">
                        <div class="vs-service-card">
                            <a class="vs-service-card-link">
                                <h3 class="vs-service-card-title">On-demand Dating <br/> App Development</h3>
                                <div class="vs-service-card-logo-list">
                                    <div class="vs-service-card-logo-item">
                    ...
                    <div class="col col-12 col-md-6 col-lg-4">
                        <div class="vs-service-card">
                            <!-- <a class="vs-service-card-link"> -->
                                <h3 class="vs-service-card-title">Hire Dating <br/> App Developers</h3>
                                <div class="vs-service-card-logo-list">
                                    <div class="vs-service-card-logo-item">
                                        <img src="{{asset('web-assets/images/dating-icon-alt.svg')}}" alt="wallet-app" class="img-fluid">
                                    </div>
                                </div>
                                <p class="vs-service-card-description">Looking to create the next big thing in online dating? Our team of dating app developers specializes in crafting user-friendly dating apps. All of them are tailored to the specific needs and demands of the customers. Let's get in touch and bring your dating app idea to life!</p>
                            <!-- </a> -->
                        </div>
                    </div>
                    <div class="col col-12 col-md-6 col-lg-4">
                        <div class="vs-service-card">
                            <!-- <a class="vs-service-card-link"> -->
                                <h3 class="vs-service-card-title">Dating <br/>Mobile App Maintenance</h3>
                                <div class="vs-service-card-logo-list">
                                    <div class="vs-service-card-logo-item">
            ...
            <div class="vs-fintech-app-feature-content">
                    ...
                    <div class="row">
                        <div class="col col-12 col-md-6 col-lg-6">
                            <div class="vs-fintech-app-feature-img text-center">
                                <img src="{{asset('web-assets/images/solutions/svg/dating-app-customer-img.svg')}}" alt="dating-app-customer-img"
                                    class="img-fluid border-0">
                            </div>
                        </div>
                        <div class="col col-12 col-md-6 col-lg-6">
                            <div class="vs-fintech-app-feature-details">
                                <h3 class="vs-section-title vs-title-border">Dating App User Panel</h3>
                                <p class="vs-section-description">
                                    The dating app user panel provides a platform for individuals to create their profiles on the dating application while scheduling dates. The process includes exclusive features like profile customization, search filters, and more to indicate interest or disinterest in other users. So, when you work on the dating app user panel, don’t forget to add the following features.
                                </p>
                                <ul class="vs-fintech-app-feature-list list-unstyled">
                                    <li class="vs-fintech-app-feature-item">
                                        ...
                                        <span>User Onboarding and Personalisation</span>
                                    </li>
                                    <li class="vs-fintech-app-feature-item">
                                        <span class="vs-fintech-app-feature-item-icon">
                                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                                    ...
                                    <li class="vs-fintech-app-feature-item">
                                        ...
                                        <span>Subscription Management & in App Purchase.</span>
                                    </li>
                                    <li class="vs-fintech-app-feature-item">
                                        <span class="vs-fintech-app-feature-item-icon">
                                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                                    ...
                                    <li class="vs-fintech-app-feature-item">
                                        ...
                                        <span>Upload Multiple Photos and Videos</span>
                                    </li>
                                    <li class="vs-fintech-app-feature-item">
                                        <span class="vs-fintech-app-feature-item-icon">
                                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                                    ...
                                    <li class="vs-fintech-app-feature-item">
                                        ...
                                        <span>Geolocation-based matching</span>
                                    </li>
                                    <li class="vs-fintech-app-feature-item">
                                        <span class="vs-fintech-app-feature-item-icon">
                                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                                        ...
                                        <span>Tinder Style Swiping features</span>
                                    </li>
                                    <li class="vs-fintech-app-feature-item">
                                        <span class="vs-fintech-app-feature-item-icon">
                                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                ...
                <div class="vs-fintech-feature-item">
                    <div class="row">
                        <div class="col col-12 col-md-6 col-lg-6">
                            <div class="vs-fintech-app-feature-img text-center">
                                <img src="{{asset('web-assets/images/solutions/svg/dating-app-owner-img.svg')}}" alt="dating-app-owner-img"
                                    class="img-fluid border-0">
                            </div>
                        </div>
                        <div class="col col-12 col-md-6 col-lg-6">
                            <div class="vs-fintech-app-feature-details">
                                <h3 class="vs-section-title vs-title-border">Dating App Admin Panel</h3>
                                <p class="vs-section-description">
                                    The admin panel is one of the crucial dating application panels. It helps to maintain the integrity and security of the dating platform. Here, Admins can oversee user accounts and check for inappropriate content. They also have the authority to ban users or remove content violating terms of service.
                                </p>
                                <ul class="vs-fintech-app-feature-list list-unstyled">
                                    <li class="vs-fintech-app-feature-item">
                                        <span class="vs-fintech-app-feature-item-icon">
                                    ...
                                    <li class="vs-fintech-app-feature-item">
                                        ...
                                        <span>Sales and User Analytics</span>
                                    </li>
                                    <li class="vs-fintech-app-feature-item">
                                        <span class="vs-fintech-app-feature-item-icon">
                                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                                    ...
                                    <li class="vs-fintech-app-feature-item">
                                        ...
                                        <span>Monitoring Reporting Tools </span>
                                    </li>
            ...
            <div class="vs-service-content mb-0">
                <div class="row">
                    <div class="col col-12 col-md-6 col-lg-4">
                        <div class="vs-service-card">
                            <a class="vs-service-card-link">
                                <h3 class="vs-service-card-title">Location-based Dating App</h3>
                                <div class="vs-service-card-logo-list">
                                    <div class="vs-service-card-logo-item">
                                        <svg width="37" height="37" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M25.328 15.4472C29.1147 10.3698 34.808 8.88718 40.0453 10.3138C45.6987 11.8525 50.6693 16.7085 52.32 23.4712C52.4053 23.8178 52.48 24.1645 52.5413 24.5112C50.1584 23.6627 47.5667 23.5973 45.144 24.3245C41.712 21.7858 37.4613 21.3592 33.6827 22.7512C28.9493 24.4978 25.2533 28.9272 24.3973 34.5005C23.304 41.6365 27.6507 48.0472 33.7973 53.4978L34.832 54.3938C33.9973 54.4525 33.1493 54.3218 32.3387 54.1485C31.922 54.0594 31.5076 53.9599 31.096 53.8498L29.664 53.4498C16.9333 49.8685 8.41067 44.2658 5.96533 35.8925C4.01333 29.2098 5.89067 22.5192 10.0187 18.3592C13.8427 14.5058 19.512 12.9432 25.328 15.4472ZM29.6693 35.3085C30.8107 27.8632 39.4213 24.1938 43.8427 30.5832C43.885 30.6426 43.9491 30.6829 44.021 30.6953C44.0929 30.7078 44.1668 30.6915 44.2267 30.6498C50.5653 26.1592 57.4 32.5512 55.9253 39.9378C55.072 44.2205 51.0987 47.7778 44.0053 50.6045L42.8453 51.0578L42.144 51.3458C41.5387 51.5832 40.8987 51.7725 40.32 51.6712C39.744 51.5698 39.208 51.1698 38.72 50.7432L37.8933 49.9965C31.7253 44.6872 28.984 39.7912 29.6693 35.3085Z" fill="#003262"/>
                                        </svg>


                                    </div>
                                </div>
                                <p class="vs-service-card-description">Allow your potential dating app users to discover love right in their neighborhood. Develop location-based dating mobile app and let the users find their match within a specified location. So, what are you waiting for? Discuss your idea for location-based dating app development and let our professional and dedicated developers guide you throughout the development process.</p>
                            </a>
                        </div>
                    </div>
                    <div class="col col-12 col-md-6 col-lg-4">
                        <div class="vs-service-card">
                            <a class="vs-service-card-link">
                                <h3 class="vs-service-card-title">Celebrity Dating App</h3>
                                <div class="vs-service-card-logo-list">
                                    <div class="vs-service-card-logo-item">
                                        <svg width="37" height="37" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col col-12 col-md-6 col-lg-4">
                        <div class="vs-service-card">
                            <a class="vs-service-card-link">
                                <h3 class="vs-service-card-title">Religious Dating App</h3>
                                <div class="vs-service-card-logo-list">
                                    <div class="vs-service-card-logo-item">
                                        <svg width="37" height="37" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M40 44.192V50.6453C39.9986 52.0655 39.4336 53.4271 38.4292 54.431C37.4247 55.435 36.0628 55.9993 34.6427 56H13.36C11.9389 56 10.576 55.4357 9.57085 54.431C8.56573 53.4264 8.00071 52.0638 8 50.6427V29.36C8 27.9389 8.56435 26.576 9.56896 25.5708C10.5736 24.5657 11.9362 24.0007 13.3573 24H21.2347" stroke="#003262" stroke-width="5.33333" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M24.4453 12.0286C24.8197 10.6372 25.7308 9.45115 26.9786 8.73073C28.2265 8.01032 29.7092 7.81439 31.1013 8.18595L51.9707 13.7779C53.3621 14.1523 54.5481 15.0634 55.2686 16.3112C55.989 17.5591 56.1849 19.0418 55.8134 20.4339L50.2214 41.3033C49.847 42.6947 48.9359 43.8807 47.6881 44.6012C46.4402 45.3216 44.9575 45.5175 43.5653 45.146L22.6933 39.554C21.3019 39.1796 20.1159 38.2685 19.3955 37.0207C18.6751 35.7728 18.4791 34.2901 18.8507 32.8979L24.4453 12.0286Z" stroke="#003262" stroke-width="5.33333" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>


                                    </div>
                                </div>
                                <p class="vs-service-card-description">Find love that shares your faith! Our Religious Dating App Development solutions caters to individuals seeking meaningful connections within their religious community. With tailored features and a secure platform, users can explore potential matches who align with their spiritual beliefs, fostering relationships built on shared values.</p>
                            </a>
                        </div>
                    </div>
                    <div class="col col-12 col-md-6 col-lg-4">
                        <div class="vs-service-card">
                            <a class="vs-service-card-link">
                                <h3 class="vs-service-card-title">Compatibility Matching Dating App</h3>
                                <div class="vs-service-card-logo-list">
                                    <div class="vs-service-card-logo-item">
                                        <svg width="37" height="37" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M40 44.192V50.6453C39.9986 52.0655 39.4336 53.4271 38.4292 54.431C37.4247 55.435 36.0628 55.9993 34.6427 56H13.36C11.9389 56 10.576 55.4357 9.57085 54.431C8.56573 53.4264 8.00071 52.0638 8 50.6427V29.36C8 27.9389 8.56435 26.576 9.56896 25.5708C10.5736 24.5657 11.9362 24.0007 13.3573 24H21.2347" stroke="#003262" stroke-width="5.33333" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                <p class="vs-service-card-description">Unlock the potential for lasting connections with compatibility matching dating app development solutions. Tailored for dating business owners, our solution utilizes advanced algorithms to match users based on compatibility factors. So, be ready to elevate your dating platform by offering a unique and personalized experience that fosters genuine connections</p>
                            </a>
                        </div>
                    </div>
                    <div class="col col-12 col-md-6 col-lg-4">
                        <div class="vs-service-card">
                            <a class="vs-service-card-link">
                                <h3 class="vs-service-card-title">Video Dating Apps</h3>
                                <div class="vs-service-card-logo-list">
                                    <div class="vs-service-card-logo-item">
                                        <svg width="37" height="37" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M4 21C4 18.6131 4.94821 16.3239 6.63604 14.636C8.32387 12.9482 10.6131 12 13 12H33C35.3869 12 37.6761 12.9482 39.364 14.636C41.0518 16.3239 42 18.6131 42 21V43C42 45.3869 41.0518 47.6761 39.364 49.364C37.6761 51.0518 35.3869 52 33 52H13C10.6131 52 8.32387 51.0518 6.63604 49.364C4.94821 47.6761 4 45.3869 4 43V21ZM59.992 19.508C59.992 15.88 55.92 13.744 52.934 15.804L45 21.284V42.716L52.936 48.196C55.92 50.256 59.992 48.12 59.992 44.492V19.508Z" fill="#003262"/>
                                        </svg>
                    ...
                    <div class="col col-12 col-md-6 col-lg-4">
                        <div class="vs-service-card">
                            <a class="vs-service-card-link">
                                <h3 class="vs-service-card-title">LGBTQ+ Dating App</h3>
                                <div class="vs-service-card-logo-list">
                                    <div class="vs-service-card-logo-item">
                                        <svg width="37" height="37" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M20 5.33398C21.4145 5.33398 22.7711 5.89589 23.7713 6.89608C24.7715 7.89628 25.3334 9.25283 25.3334 10.6673C25.3334 12.0818 24.7715 13.4384 23.7713 14.4386C22.7711 15.4387 21.4145 16.0007 20 16.0007C18.5855 16.0007 17.229 15.4387 16.2288 14.4386C15.2286 13.4384 14.6667 12.0818 14.6667 10.6673C14.6667 9.25283 15.2286 7.89628 16.2288 6.89608C17.229 5.89589 18.5855 5.33398 20 5.33398ZM16 18.6673H24C25.4145 18.6673 26.7711 19.2292 27.7713 20.2294C28.7715 21.2296 29.3334 22.5862 29.3334 24.0007V38.6673H25.3334V58.6673H14.6667V38.6673H10.6667V24.0007C10.6667 22.5862 11.2286 21.2296 12.2288 20.2294C13.229 19.2292 14.5855 18.6673 16 18.6673ZM44 5.33398C45.4145 5.33398 46.7711 5.89589 47.7713 6.89608C48.7715 7.89628 49.3334 9.25283 49.3334 10.6673C49.3334 12.0818 48.7715 13.4384 47.7713 14.4386C46.7711 15.4387 45.4145 16.0007 44 16.0007C42.5855 16.0007 41.229 15.4387 40.2288 14.4386C39.2286 13.4384 38.6667 12.0818 38.6667 10.6673C38.6667 9.25283 39.2286 7.89628 40.2288 6.89608C41.229 5.89589 42.5855 5.33398 44 5.33398ZM40 18.6673H48C49.4145 18.6673 50.7711 19.2292 51.7713 20.2294C52.7715 21.2296 53.3334 22.5862 53.3334 24.0007V38.6673H49.3334V58.6673H38.6667V38.6673H34.6667V24.0007C34.6667 22.5862 35.2286 21.2296 36.2288 20.2294C37.229 19.2292 38.5855 18.6673 40 18.6673Z" fill="#003262"/>
                                        </svg>
                    ...
                    <div class="col col-12 col-md-6 col-lg-4">
                        <div class="vs-famous-fantasy-card">
                            <div class="vs-famous-fantasy-card-logo">
                                <img src="{{asset('web-assets/images/tinder-icon.svg')}}" alt="tinder" class="img-fluid" style="height:auto">
                            </div>
                            <div class="vs-famous-fantasy-card-body">
                                <h3 class="vs-famous-fantasy-card-title">Tinder</h3>
                                <p class="vs-famous-fantasy-description">Tinder is one of the most widely used dating apps globally. This dating app is known for its simple swipe-right-to-like and swipe-left-to-pass interface. It allows users to browse through profiles based on location and preferences. With its large user base and intuitive design, Tinder remains a top choice for many singles seeking casual or serious relationships.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col col-12 col-md-6 col-lg-4">
                        <div class="vs-famous-fantasy-card">
                            <div class="vs-famous-fantasy-card-logo">
                                <img src="{{asset('web-assets/images/bumble-icon.svg')}}" alt="Bumble-lion" class="img-fluid" style="height:auto">
                            </div>
                            <div class="vs-famous-fantasy-card-body">
                                <h3 class="vs-famous-fantasy-card-title">Bumble</h3>
                                <p class="vs-famous-fantasy-description">Bumble puts women in control. It allows them to initiate conversations with potential matches within 24 hours of connecting. This unique feature of Bumble empowers women to make the first move. Beyond dating, Bumble also offers features for networking and finding new friends. Overall, this dating application caters to a diverse range of social needs.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col col-12 col-md-6 col-lg-4">
                        <div class="vs-famous-fantasy-card">
                            <div class="vs-famous-fantasy-card-logo">
                                <img src="{{asset('web-assets/images/hinge-icon.svg')}}" alt="Hinge" class="img-fluid" style="height:auto">
                            </div>
                            <div class="vs-famous-fantasy-card-body">
                                <h3 class="vs-famous-fantasy-card-title">Hinge</h3>
                                <p class="vs-famous-fantasy-description">Hinge distinguishes itself by focusing on building genuine connections through detailed profiles. Its prompts encourage users to showcase their personalities. Hinge emphasizes the importance of meaningful conversations and compatibility. Due to this, it is popular among individuals seeking more than just casual encounters. So, if you want to create dating app like Hinge, connect with us. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col col-12 col-md-6 col-lg-4">
                        <div class="vs-famous-fantasy-card">
                            <div class="vs-famous-fantasy-card-logo">
                                <img src="{{asset('web-assets/images/OkCupid-icon.svg')}}" alt="OkCupid" class="img-fluid" style="height:auto">
                            </div>
                            <div class="vs-famous-fantasy-card-body">
                                <h3 class="vs-famous-fantasy-card-title">OkCupid</h3>
                                <p class="vs-famous-fantasy-description">OkCupid is known for its comprehensive questionnaire and in-depth profiles. This app helps users find compatible matches based on shared interests, values, and beliefs. It offers a range of features, including customizable preferences and personality quizzes. OkCupid's inclusivity and commitment to user privacy have contributed to its popularity.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col col-12 col-md-6 col-lg-4">
                        <div class="vs-famous-fantasy-card">
                            <div class="vs-famous-fantasy-card-logo">
                                <img src="{{asset('web-assets/images/Coffemeetsbagel-icon.svg')}}" alt="Coffemeetsbagel-app" class="img-fluid" style="height:auto">
                            </div>
                            <div class="vs-famous-fantasy-card-body">
                                <h3 class="vs-famous-fantasy-card-title">Coffee Meets Bagel (CMB)</h3>
                                <p class="vs-famous-fantasy-description">Coffee Meets Bagel takes a curated approach to online dating. It sends users a limited number of matches, or "bagels," daily at noon. It encourages users to focus on quality over quantity. With its emphasis on meaningful connections and user feedback, Coffee Meets Bagel appeals to singles looking for more intentional dating experiences.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="vs-portfolio-content__inner">
                            <div class="vs-portfolio-slider">
                                        ...
                                        <div class="row">
                                            <div class="col col-12 col-md-4 col-lg-4">
                                                <div class="vs-portfolio-item-img">
                                                    <img src="{{asset('web-assets/images/new-portfolio/JAUMO -Dating App.png')}}"
                                                    ...
                                                    <div class="vs-portfolio-heading">
                                                        <div class="vs-portfolio-heading-top">
                                                            <div class="vs-portfolio-logo">
                                                                <img src="{{asset('web-assets/images/new-portfolio/logo/JAUMO -Dating App.png')}}"
                                                                    alt="app-logo" class="img-fluid">
                                                            </div>
                                                            <div class="vs-portfolio-heading__inner">
                                                                <h3 class="vs-portfolio-title"><span>JAUMO -Dating App</span>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                        <p class="vs-portfolio-heading-desccription">JAUMO is a dating app that allows users to meet new people, chat, and find love or friendship. It has a user-friendly interface and offers features such as profile verification, photo moderation, and location-based matching.</p>
                                                        ...
                                                        <div class="vs-portfolio-body">
                                                            <div class="vs-portfolio-info">
                                                                ...
                                                                <div class="vs-portfolio-info-item">
                                                                    ...
                                                                    <p class="vs-portfolio-info-text">Figma, React Native, Python</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="vs-portfolio-footer">
                                                                ...
                                                                <a href="https://play.google.com/store/apps/details?id=com.jaumo&amp;hl=en_IN&amp;gl=US" class="vs-portfolio-footer-link" target="_blank">
                                                                            ...
                                                                            <clipPath id="clip0_5730_20582">
                                                                                <rect width="135" height="40" fill="white"
                                                                                    transform="translate(0.5625 0.40625)" />
                                                                                                                            ...
                                                                                                                            <div class="vs-portfolio-footer-item">
                                                                <a href="https://apps.apple.com/in/app/jaumo-dating-app-chat-flirt/id522681493" class="vs-portfolio-footer-link" target="_blank">
                                        ...
                                        <div class="row">
                                            <div class="col col-12 col-md-4 col-lg-4">
                                                <div class="vs-portfolio-item-img">
                                                    <img src="{{asset('web-assets/images/new-portfolio/DISCO-Dating App.png')}}"
                                                        alt="demand-grocery-img" class="img-fluid">
                                                </div>
                                            </div>
                                            <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                                                <div class="vs-portfolio-details">
                                                    <div class="vs-portfolio-heading">
                                                        <div class="vs-portfolio-heading-top">
                                                            <div class="vs-portfolio-logo">
                                                                <img src="{{asset('web-assets/images/new-portfolio/logo/DISCO-Dating App.png')}}"
                                                                    alt="app-logo" class="img-fluid">
                                                            </div>
                                                            <div class="vs-portfolio-heading__inner">
                                                                <h3 class="vs-portfolio-title"><span>DISCO-Dating App</span>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                        <p class="vs-portfolio-heading-desccription">DISCO is a dating app that focuses on connecting people through shared interests and activities. It allows users to create profiles, swipe through potential matches, and chat with others who have similar interests.</p>
                                                        ...
                                                        <div class="vs-portfolio-footer">
                                                                                                                            ...
                                                                                                                            <div class="vs-portfolio-footer-item">
                                                                <a href="https://play.google.com/store/apps/details?id=com.jaumo.gay&amp;hl=en_IN&amp;gl=US" class="vs-portfolio-footer-link" target="_blank">
                                                                    <svg width="136" height="41" viewBox="0 0 136 41"
                                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <g clip-path="url(#clip0_5730_20582)">
                                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        <div class="row">
                                            <div class="col col-12 col-md-4 col-lg-4">
                                                <div class="vs-portfolio-item-img">
                                                    <img src="{{asset('web-assets/images/new-portfolio/Taimi-Dating App.png')}}"
                                                        alt="demand-grocery-img" class="img-fluid">
                                                </div>
                                            </div>
                                            <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                                                <div class="vs-portfolio-details">
                                                    <div class="vs-portfolio-heading">
                                                        <div class="vs-portfolio-heading-top">
                                                            <div class="vs-portfolio-logo">
                                                                <img src="{{asset('web-assets/images/new-portfolio/logo/Taimi-Dating App.png')}}"
                                                                    alt="app-logo" class="img-fluid">
                                                            </div>
                                                            <div class="vs-portfolio-heading__inner">
                                                                <h3 class="vs-portfolio-title"><span>Taimi-Dating App</span>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                        <p class="vs-portfolio-heading-desccription">Taimi is a dating and social networking app for LGBTQ+ individuals. It is designed to provide a safe and inclusive space for people to connect, chat, and meet new friends or potential romantic partners. The app also offers features such as video calls, stories, and groups to help users interact and engage with each other.</p>
                                                        ...
                                                        <div class="vs-portfolio-footer">
                                                                                                                            ...
                                                                                                                            <div class="vs-portfolio-footer-item">
                                                                <a href="https://play.google.com/store/apps/details?id=com.takimi.android&amp;hl=en_IN&amp;gl=US" class="vs-portfolio-footer-link" target="_blank">
                                                                    <svg width="136" height="41" viewBox="0 0 136 41"
                                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <g clip-path="url(#clip0_5730_20582)">
                                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        <div class="row">
                                            <div class="col col-12 col-md-4 col-lg-4">
                                                <div class="vs-portfolio-item-img">
                                                    <img src="{{asset('web-assets/images/new-portfolio/Poly-Dating App.png')}}"
                                                        alt="demand-grocery-img" class="img-fluid">
                                                </div>
                                            </div>
                                            <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                                                <div class="vs-portfolio-details">
                                                    <div class="vs-portfolio-heading">
                                                        <div class="vs-portfolio-heading-top">
                                                            <div class="vs-portfolio-logo">
                                                                <img src="{{asset('web-assets/images/new-portfolio/logo/Poly-Dating App.png')}}"
                                                                    alt="app-logo" class="img-fluid">
                                                            </div>
                                                            <div class="vs-portfolio-heading__inner">
                                                                <h3 class="vs-portfolio-title"><span>Poly-Dating App</span>
                                                                </h3>
                                                            </div>
                                                        </div>
                                                        <p class="vs-portfolio-heading-desccription">Poly-Dating app is a dating app specifically designed for individuals who are interested in polyamorous relationships, where they can have multiple romantic partners at the same time with the consent of all parties involved. This app provides a platform for like-minded individuals to connect, communicate, and potentially form meaningful relationships.</p>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingFaq1">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                Which is the Dating App Development Company?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingFaq3">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                How Can I Hire Dedicated Dating App Developers Within a Reasonable Cost?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingFaq5">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Do You Provide Dating App Support and Maintenance Services?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingFaq7">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Can I Hire Dating App Developers on an Hourly or Part-time Basis?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingFaq8">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                What Are the Benefits of Dating App Development for Businesses?
                            </button>
                        </h2>
                        <div id="collapseFaq8" class="accordion-collapse collapse" aria-labelledby="headingFaq8"
                            data-bs-parent="#tyFaq">
                            <div class="accordion-body">
                                <p>Developing a dating app can benefit businesses by tapping into a lucrative market, fostering user engagement, and generating revenue through subscriptions and advertisements. Additionally, it offers valuable data insights for targeted marketing and improves brand visibility and recognition in the competitive digital landscape.</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingFaq9">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                ...
                                Are There Any Additional Or Hidden Charges to Create a Dating App?
                            </button>
                        </h2>
                        ...
                        <h2 class="accordion-header" id="headingFaq5">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseFaq10" aria-expanded="false" aria-controls="collapseFaq10">
                                 I Need to Develop A Dating in Less Time. Could You Help Me with That?
                            </button>
                        </h2>
