...
<main class="vs-site-content">
    <!-- ======= Hero Section ======= -->
    <section class="ar-vr-hero pt-0 vs-hiring-landing-section">
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 mb-5 mb-lg-0" data-aos="fade-in" data-aos-delay="100">
            ...
            <div class="ar-vr-banner--sub-text">
              <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#requestProposalModal"
                class="cta mt-3 d-inline-block">Request a call back</a>
              <p class="note banner-dis">
          ...
          <div class="col-lg-6">
            <div class="ios-banner">
              <img class="img-fluid" src="web-assets/images/ar-vr.svg" alt="ar app developemnet" />
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- End Hero -->
    <!-- <section class="description-block bubble-bg" data-aos="fade-up" data-aos-delay="100">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <p class="text-center big-p">We provide a wide range of Blockchain Development Services. Based
                        on our discussion with our clients on their business objective, problem statement and
                        expansion plan we propose the right Blockchain and <br>Crypto solution and start with the
                        project accordingly.</p>
                </div>
            </div>
        </div>
    </section> -->
      ...
      <div class="container">
        <div class="vs-heading-center">
          ...
          <p class="vs-section-description w-100">
            ...
            development solutions to meet evolving needs. We help businesses
            stay competitive and achieve long-term success in the
            ever-evolving virtual and augmented reality landscape.
          </p>
        </div>
        <div class="vs-service-content mb-0">
          <div class="row">
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  <h3 class="vs-service-card-title">Custom AR Development</h3>
                  <div class="vs-service-card-logo-list">
                    <div class="vs-service-card-logo-item">
                      <img src="web-assets/images/ar-vr/custom-ar-dev.svg" style="
                  ...
                  <p class="vs-service-card-description">
                    Tailored AR (Augmented Reality) solutions to meet specific
                    client needs, including creating unique AR apps or
                    experiences for marketing, education, or training.
                  </p>
                </a>
              </div>
            </div>
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  <h3 class="vs-service-card-title">Web AR Development</h3>
                  <div class="vs-service-card-logo-list">
                    <div class="vs-service-card-logo-item">
                      <img src="web-assets/images/ar-vr/ar-web.svg" style="
                            background-color: #fb923c;
                            padding: 15%;
                            border-radius: 5px;
                          " width="50px" height="50px" />
                  ...
                  <p class="vs-service-card-description">
                    Building AR experiences accessible through web browsers,
                    eliminating the need for a dedicated app by leveraging
                    technologies like WebAR.js or A-Frame.
                  </p>
                </a>
              </div>
            </div>
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  <h3 class="vs-service-card-title">AR Game Development</h3>
                  <div class="vs-service-card-logo-list">
                    <div class="vs-service-card-logo-item">
                      <img src="web-assets/images/ar-vr/ar-game.svg" style="
                            background-color: #fb923c;
                            padding: 15%;
                            border-radius: 5px;
                          " width="50px" height="50px" />
                  ...
                  <p class="vs-service-card-description">
                    We offer immersive and interactive AR games that merge the
                    digital and physical worlds for engaging gameplay
                    experiences.
                  </p>
                </a>
              </div>
            ...
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  <h3 class="vs-service-card-title">Unity Development</h3>
                  <div class="vs-service-card-logo-list">
                    <div class="vs-service-card-logo-item">
                      <img src="web-assets/images/ar-vr/ar-unity.svg" style="
                            background-color: #fb923c;
                            padding: 15%;
                            border-radius: 5px;
                          " width="50px" height="50px" />
                  ...
                  <p class="vs-service-card-description">
                    Our dedicated developers utilize Unity, a popular game
                    engine, to develop AR applications and games with
            ...
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  ...
                  <div class="vs-service-card-logo-list">
                    <div class="vs-service-card-logo-item">
                      <img src="web-assets/images/ar-vr/ar-andriod.svg" style="
                            background-color: #fb923c;
                            padding: 15%;
                            border-radius: 5px;
                          " width="50px" height="50px" />
                  ...
                  <p class="vs-service-card-description">
                    We develop AR-based applications for Android devices,
                    utilizing Google's ARCore platform for Android-based AR
                    experiences.
                  </p>
                </a>
              </div>
            ...
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  <h3 class="vs-service-card-title">Apple ARKit</h3>
                  <div class="vs-service-card-logo-list">
                    <div class="vs-service-card-logo-item">
                      <img src="web-assets/images/ar-vr/ar-apple-kit.svg" style="
                            background-color: #fb923c;
                            padding: 15%;
                            border-radius: 5px;
                          " width="50px" height="50px" />
                  ...
                  <p class="vs-service-card-description">
                    Our experts focus on AR development for Apple devices,
                    leveraging Apple's ARKit framework to create AR
                    applications and games for iOS devices.
                  </p>
                </a>
              </div>
            </div>
    ...
    <section class="vs-something-everyone-section vs-section-spacer">
      ...
      <div class="container">
        <div class="vs-heading-center w-75">
          <h2 class="vs-section-title vs-title-border">
          ...
          <p class="vs-section-description w-75 m-auto">
            ...
            our budget-friendly pricing models.
          </p>
        </div>
          ...
          <div class="row">
              ...
              <div class="vs-everyone-card">
                ...
                <div class="vs-everyone-card-body">
                  <p class="vs-everyone-description">
                    ...
                    specific set of AR/VR app development project.
                  </p>
            ...
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-everyone-card">
                ...
                <div class="vs-everyone-card-body">
                  <p class="vs-everyone-description">
                    Hire dedicated AR/VR app developers who can help you
                    create an AR-powered application.
                  </p>
                  <ul class="vs-everyone-feature-list list-unstyled">
                    <li class="vs-everyone-feature-item">
                      <span class="vs-everyone-feature-icon">
            ...
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-everyone-card">
                ...
                <div class="vs-everyone-card-body">
                  <p class="vs-everyone-description">
                    Get a white label AR/VR app development solution and be
              ...
              <div class="vs-why-choose-content__inner">
                <div class="vs-why-choose-description">
                  <p>
                    ...
                    seamless integration, high interactivity, and realistic
                    simulations, pushing the boundaries of possibility. Choose
                    us to create unforgettable virtual worlds and augmented
                    realities that elevate your brand and engage your audience
                ...
                <div class="vs-why-choose-card-list" data-scrollbar>
                  <div class="vs-why-choose-card-item">
                    <div class="vs-why-choose-card">
                      ...
                      <p class="vs-why-choose-card-desription">
                        Our devoted team of AR/VR developers has years of
                        experience in each of their specialized fields. They
                        are very competent and can quickly transform your
                        ambitious concept into a mobile application that is
                        driven by growth.
                      </p>
                    </div>
                  </div>
                  <div class="vs-why-choose-card-item">
                    <div class="vs-why-choose-card">
                      ...
                      <p class="vs-why-choose-card-desription">
                        We respect each company's financial resources and are
                        aware of its financial constraints. Because of this,
                        we provide very affordable AR/VR app development
                  ...
                  <div class="vs-why-choose-card-item">
                    <div class="vs-why-choose-card">
                      ...
                      <p class="vs-why-choose-card-desription">
                        We think one of the most crucial elements for a
                        project's success is timely delivery. So you can relax
                        knowing that our engineers will make sure your created
                        milestones are delivered on schedule.
                      </p>
                    </div>
                  </div>
                  <div class="vs-why-choose-card-item">
                    <div class="vs-why-choose-card">
                      ...
                      <p class="vs-why-choose-card-desription">
                        You can determine the order of modules to be finished
                        and learn about the next objective the developers will
                        work on for the day by attending the daily scrum
                        sessions.
                      </p>
                    </div>
                  </div>
                  <div class="vs-why-choose-card-item">
                    <div class="vs-why-choose-card">
                      ...
                      <p class="vs-why-choose-card-desription">
                        Our qualified quality analysts carry out rigid quality
                        assurance procedures. They always guarantee that the
                        app satisfies the exacting requirements of
                        organizations and is bug-free, dependable, and strong.
                      </p>
                    </div>
                  </div>
                  <div class="vs-why-choose-card-item">
                    <div class="vs-why-choose-card">
                      ...
                      <p class="vs-why-choose-card-desription">
                        To ensure that the mobile application remains
                        functional, safe, and current with evolving
                        technologies and user needs, we offer ongoing support,
    ...
    <section class="vs-want-discuss-section vs-section-spacer">
      <div class="container">
        <div class="vs-heading-center">
          <h2 class="vs-section-title vs-title-border">
            Drop Your Requirements for AR/VR App Development!
          </h2>
          <p class="vs-section-description">
        ...
        <div class="text-center">
          <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#requestProposalModal"
            class="btn btn-outline-light">Talk to Experts</a>
        </div>
      </div>
    </section>
    ...
    <section class="vs-technology-section vs-section-spacer">
      <div class="container">
        ...
        <div class="vs-technology-content">
          <div class="row">
            <div class="col col-12 col-md-6 col-lg-6">
              <div class="nav flex-column nav-pills me-3" id="ty-stack-tab" role="tablist" aria-orientation="vertical">
                <div class="nav-link active" id="ty-stack-web-tab" data-bs-toggle="pill" data-bs-target="#ty-stack-web"
                  role="tab" aria-controls="ty-stack-web" aria-selected="true">
                ...
                <div class="nav-link" id="ty-stack-mobile-tab" data-bs-toggle="pill" data-bs-target="#ty-stack-mobile"
                  role="tab" aria-controls="ty-stack-mobile" aria-selected="false">
                  <div class="vs-technology-stack-tab-btn">
            ...
            <div class="col col-12 col-md-6 col-lg-6">
              <div class="tab-content" id="ty-stack-tabContent">
                ...
                <div class="tab-pane fade" id="ty-stack-mobile" role="tabpanel" aria-labelledby="ty-stack-mobile-tab">
                  <div class="vs-stack-tabContent__inner">
                    <div class="vs-stack-content-item">
                ...
                <div class="vs-portfolio-slider">
                    ...
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="web-assets/images/new-portfolio/7 NOW – Food &amp; Alcohol Delivery App.png"
                          ...
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img
                                  src="web-assets/images/new-portfolio/logo/7 NOW – Food &amp; Alcohol Delivery App.png"
                                  alt="app-logo" class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                                  <span>7 NOW – Food &amp; Alcohol Delivery
                                    App</span>
                                </h3>
                              </div>
                            </div>
                            <p class="vs-portfolio-heading-desccription">
                              7 Now is a premier food and alcohol delivery app
                              offering a curated selection of culinary
                              delights and beverages. With a user-friendly
                              interface and swift delivery, it&#039;s an
                              all-encompassing platform that ensures an
                              exceptional dining and drinking experience.
                            </p>
                            ...
                            <div class="vs-portfolio-footer">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://play.google.com/store/apps/details?id=com.seven.eleven.phoenix"
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://apps.apple.com/us/app/7now-food-alcohol-delivery/id1316244211"
                                  class="vs-portfolio-footer-link" target="_blank">
                  ...
                  <div class="vs-portfolio-item" style="background-color: #ffd4b9">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="web-assets/images/new-portfolio/Akasha Airlines – Flight Booking app.png"
                            alt="demand-grocery-img" class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img
                                  src="web-assets/images/new-portfolio/logo/Akasha Airlines – Flight Booking app.png"
                                  alt="app-logo" class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                                  <span>Akasha Airlines – Flight Booking
                                    app</span>
                                </h3>
                              </div>
                            </div>
                            <p class="vs-portfolio-heading-desccription">
                              Akasha Airlines is one of India&#039;s newest
                              low-cost airlines based out in India. Its app is
                              very user-friendly. While using this app, users
                              can seamlessly book flights, manage their
                              bookings, check flight status, and more. The app
                              offers exclusive deals and discounts as well.
                            </p>
                            ...
                            <div class="vs-portfolio-body">
                              <div class="vs-portfolio-info">
                                <div class="vs-portfolio-info-item">
                                  ...
                                  <p class="vs-portfolio-info-text vs-portfolio-info-region">
                                    <img style="padding-right: 10px" width="25%"
                                      src="web-assets/images/new-portfolio/flags/small/India.png" alt="app-logo"
                                      class="img-fluid" />
                                    <!-- <span class="vs-portfolio-info-flag">
                                                                                <svg width="25" height="25" viewBox="0 0 25 25"
                                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="vs-portfolio-footer">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://play.google.com/store/apps/details?id=com.akasaair.ibe"
                                  class="vs-portfolio-footer-link" target="_blank">
                                  <svg width="136" height="41" viewBox="0 0 136 41" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_5730_20582)">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://apps.apple.com/in/app/akasa-air/id1629829548"
                                  class="vs-portfolio-footer-link" target="_blank">
                                  <svg width="121" height="41" viewBox="0 0 121 41" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_5730_20583)">
                  ...
                  <div class="vs-portfolio-item" style="background-color: #ffd8d9">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="web-assets/images/new-portfolio/Baaz app - Social Media Platform.png"
                            alt="demand-grocery-img" class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img src="web-assets/images/new-portfolio/logo/Baaz app - Social Media Platform.png"
                                  alt="app-logo" class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                                  <span>Baaz app - Social Media Platform</span>
                                </h3>
                              </div>
                            </div>
                            <p class="vs-portfolio-heading-desccription">
                              Baaz is a social media hub uniting diverse
                              platforms via a single interface. It offers a
                              comprehensive view of trending discussions,
                              news, and user-generated content, simplifying
                            ...
                            <div class="vs-portfolio-body">
                              <div class="vs-portfolio-info">
                                <div class="vs-portfolio-info-item">
                                  ...
                                  <p class="vs-portfolio-info-text vs-portfolio-info-region">
                                    <img style="padding-right: 10px" width="25%"
                                      src="web-assets/images/new-portfolio/flags/small/Tanzania.png" alt="app-logo"
                                      class="img-fluid" />
                                    <!-- <span class="vs-portfolio-info-flag">
                                                                                <svg width="25" height="25" viewBox="0 0 25 25"
                                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="vs-portfolio-footer">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://play.google.com/store/search?q=Baaz&amp;c=apps&amp;hl=en&amp;gl=US"
                                  class="vs-portfolio-footer-link" target="_blank">
                                  <svg width="136" height="41" viewBox="0 0 136 41" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_5730_20582)">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://apps.apple.com/us/app/baaz/id1092130570"
                                  class="vs-portfolio-footer-link" target="_blank">
                                  <svg width="121" height="41" viewBox="0 0 121 41" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_5730_20583)">
                  ...
                  <div class="vs-portfolio-item" style="background-color: #f8bbff">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="web-assets/images/new-portfolio/Booster Rewards - (Reward App).png"
                            alt="demand-grocery-img" class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img src="web-assets/images/new-portfolio/logo/Booster Rewards - (Reward App).png"
                                  alt="app-logo" class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                                  <span>Booster Rewards - (Reward App)</span>
                                </h3>
                              </div>
                            </div>
                            <p class="vs-portfolio-heading-desccription">
                              Booster Rewards is a dynamic rewards program
                              that enhances customer engagement. Tailored for
                              businesses, it offers a gamified experience,
                              encouraging loyalty through points, discounts,
                              and exclusive perks. Elevate your brand&#039;s
                              customer relationships with this innovative
                              tool, driving repeat purchases and fostering a
                              dedicated clientele.
                            </p>
                            ...
                            <div class="vs-portfolio-footer">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://play.google.com/store/apps/details?id=com.olo.boosterjuice&amp;hl=en&amp;gl=US"
                                  class="vs-portfolio-footer-link" target="_blank">
                                  <svg width="136" height="41" viewBox="0 0 136 41" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_5730_20582)">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://apps.apple.com/in/app/booster-rewards/id1528598899"
                                  class="vs-portfolio-footer-link" target="_blank">
                                  <svg width="121" height="41" viewBox="0 0 121 41" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_5730_20583)">
                  ...
                  <div class="vs-portfolio-item" style="background-color: #e4deff">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="web-assets/images/new-portfolio/Doos Karting App.png" alt="demand-grocery-img"
                            class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img src="web-assets/images/new-portfolio/logo/Doos Karting App.png" alt="app-logo"
                                  class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                                  <span>Doos Karting App</span>
                                </h3>
                              </div>
                            </div>
                            <p class="vs-portfolio-heading-desccription">
                              Dooskarting is a Saudi Arabia company that
                              offers electronic kart racing to their
                              customers. They are part of Osool Entertainment,
                              the pioneer in entertainment activities in Saudi
                              Arabian region. This app is developed to allow
                              customers to book kart race tickets, order food
                              items and track their race results. The results
                              are directly integrated through the IOT sensors,
                              and as soon as the race is over, users can track
                              their position on the app itself. Region
                            </p>
                            ...
                            <div class="vs-portfolio-footer">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://play.google.com/store/apps/details?id=com.dooskarting.app"
                                  class="vs-portfolio-footer-link" target="_blank">
                                  <svg width="136" height="41" viewBox="0 0 136 41" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_5730_20582)">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://apps.apple.com/us/app/doos-karting/id1610315037"
                                  class="vs-portfolio-footer-link" target="_blank">
                                  <svg width="121" height="41" viewBox="0 0 121 41" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_5730_20583)">
                  ...
                  <div class="vs-portfolio-item" style="background-color: #ffdbec">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="web-assets/images/new-portfolio/Ginga - Fantasy App.png" alt="demand-grocery-img"
                            class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img src="web-assets/images/new-portfolio/logo/Ginga - Fantasy App.png" alt="app-logo"
                                  class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                                  <span>Ginga - Fantasy App</span>
                                </h3>
                              </div>
                            </div>
                            <p class="vs-portfolio-heading-desccription">
                              Ginga is Malaysiya&#039;s first fantasy app for
                              football lovers. It allows users to signup,
                              create their team, and invite their friends to
                              play the EPL season fantasy game, they can
                              manage their players, budget, and earnings on
                              the platform in real-time. This app also offers
                              an e- commerce store with users can purchase
                              merchandise
                            </p>
                            ...
                            <div class="vs-portfolio-body">
                              <div class="vs-portfolio-info">
                                <div class="vs-portfolio-info-item">
                                  ...
                                  <p class="vs-portfolio-info-text vs-portfolio-info-region">
                                    <img style="padding-right: 10px" width="25%"
                                      src="web-assets/images/new-portfolio/flags/small/Malaysia.png" alt="app-logo"
                                      class="img-fluid" />
                                    <!-- <span class="vs-portfolio-info-flag">
                                                                                <svg width="25" height="25" viewBox="0 0 25 25"
                                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="vs-portfolio-item" style="background-color: #ffdc8e">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="web-assets/images/new-portfolio/Imwow- Health &amp; Fitness App.png"
                            alt="demand-grocery-img" class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img src="web-assets/images/new-portfolio/logo/Imwow- Health &amp; Fitness App.png"
                                  alt="app-logo" class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                                  <span>Imwow- Health &amp; Fitness App</span>
                                </h3>
                              </div>
                            </div>
                            <p class="vs-portfolio-heading-desccription">
                              Imwow is a india based startup focused on
                              health, fitness and lifestyle. It helps users to
                              achieve their fitness goals via personalized
                              diet plans, workout videos, and one-on-one
                              coaching with the Imwow app. If you are planning
                              to stay fit while improving your overall health,
                              such a health and fitness app can be a good
                              guide for you.
                            </p>
                            ...
                            <div class="vs-portfolio-body">
                              <div class="vs-portfolio-info">
                                ...
                                <div class="vs-portfolio-info-item">
                                  <label class="vs-portfolio-info-label">Technology</label>
                                  <p class="vs-portfolio-info-text">
                                    Figma, React Native, MongoDB, Node.js
                                  </p>
                                </div>
                              </div>
                            </div>
                            <div class="vs-portfolio-footer">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://play.google.com/store/apps/details?id=com.imwow&amp;hl=en_IN&amp;gl=US"
                                  class="vs-portfolio-footer-link" target="_blank">
                                  <svg width="136" height="41" viewBox="0 0 136 41" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_5730_20582)">
                  ...
                  <div class="vs-portfolio-item" style="background-color: #a7e9ff">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="web-assets/images/new-portfolio/Justlife - Home Services App.png"
                            alt="demand-grocery-img" class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img src="web-assets/images/new-portfolio/logo/Justlife - Home Services App.png"
                                  alt="app-logo" class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                                  <span>Justlife - Home Services App</span>
                                </h3>
                              </div>
                            </div>
                            <p class="vs-portfolio-heading-desccription">
                              Justlife is an innovative, on-demand home
                              services app designed for seamless access to
                              household assistance. Offering a diverse range
                              of services, from cleaning to repairs, it
                              connects users with skilled professionals
                              efficiently, ensuring a convenient solution for
                              all their home service needs.
                            </p>
                            ...
                            <div class="vs-portfolio-body">
                              <div class="vs-portfolio-info">
                                <div class="vs-portfolio-info-item">
                                  ...
                                  <p class="vs-portfolio-info-text vs-portfolio-info-region">
                                    <img style="padding-right: 10px" width="25%"
                                      src="web-assets/images/new-portfolio/flags/small/UAE.png" alt="app-logo"
                                      class="img-fluid" />
                                    <!-- <span class="vs-portfolio-info-flag">
                                                                                <svg width="25" height="25" viewBox="0 0 25 25"
                                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="vs-portfolio-footer">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://play.google.com/store/apps/details?id=com.mobile.justmop&amp;hl=en_IN&amp;gl=US"
                                  class="vs-portfolio-footer-link" target="_blank">
                                  <svg width="136" height="41" viewBox="0 0 136 41" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_5730_20582)">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://apps.apple.com/in/app/justlife-justmop/id1107705982?platform=iphone"
                                  class="vs-portfolio-footer-link" target="_blank">
                                  <svg width="121" height="41" viewBox="0 0 121 41" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_5730_20583)">
                  ...
                  <div class="vs-portfolio-item" style="background-color: #d3e1fe">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="web-assets/images/new-portfolio/Just Market Trading - Online Trading App.png"
                            alt="demand-grocery-img" class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img
                                  src="web-assets/images/new-portfolio/logo/Just Market Trading - Online Trading App.png"
                                  alt="app-logo" class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                                  <span>Just Market Trading - Online Trading
                                    App</span>
                                </h3>
                              </div>
                            </div>
                            <p class="vs-portfolio-heading-desccription">
                              Just Market Trading is a cutting-edge online
                              trading app that empowers users to navigate
                              financial markets effortlessly. Packed with
                              real-time data, an intuitive interface, and
                              powerful analytical tools, it provides a
                              seamless trading experience. Elevate your
                              investment game with this comprehensive
                              platform, making informed decisions at your
                              fingertips.
                            </p>
                            ...
                            <div class="vs-portfolio-footer">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://play.google.com/store/apps/details?id=com.justmarkets&amp;hl=en_IN&amp;gl=US"
                                  class="vs-portfolio-footer-link" target="_blank">
                                  <svg width="136" height="41" viewBox="0 0 136 41" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_5730_20582)">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://apps.apple.com/us/app/justforex/id1489327144"
                                  class="vs-portfolio-footer-link" target="_blank">
                                  <svg width="121" height="41" viewBox="0 0 121 41" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_5730_20583)">
                  ...
                  <div class="vs-portfolio-item" style="background-color: #fee1db">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="web-assets/images/new-portfolio/Kidzin - Shopping App.png" alt="demand-grocery-img"
                            class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img src="web-assets/images/new-portfolio/logo/Kidzin - Shopping App.png"
                                  alt="app-logo" class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                                  <span>Kidzin - Shopping App</span>
                                </h3>
                              </div>
                            </div>
                            <p class="vs-portfolio-heading-desccription">
                              Kidzin is a premier shopping app designed for
                              parents and guardians, offering a curated
                              selection of children&#039;s products. With an
                              intuitive interface and a wide range of quality
                              items, it simplifies shopping for kids. Discover
                              convenience and style in one place, ensuring a
                              delightful shopping experience for both parents
                              and children.
                            </p>
                            ...
                            <div class="vs-portfolio-footer">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://play.google.com/store/apps/details?id=com.kidizen&amp;hl=en"
                                  class="vs-portfolio-footer-link" target="_blank">
                                  <svg width="136" height="41" viewBox="0 0 136 41" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_5730_20582)">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://apps.apple.com/us/app/kidizen/id395245595"
                                  class="vs-portfolio-footer-link" target="_blank">
                                  <svg width="121" height="41" viewBox="0 0 121 41" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_5730_20583)">
                  ...
                  <div class="vs-portfolio-item" style="background-color: #a6efff">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="web-assets/images/new-portfolio/MFine - Healthcare App.png"
                            alt="demand-grocery-img" class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img src="web-assets/images/new-portfolio/logo/MFine - Healthcare App.png"
                                  alt="app-logo" class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                  ...
                  <div class="vs-portfolio-item" style="background-color: #cbefff">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="web-assets/images/new-portfolio/Revv - Ride Sharing App.png"
                            alt="demand-grocery-img" class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img src="web-assets/images/new-portfolio/logo/Revv - Ride Sharing App.png"
                                  alt="app-logo" class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                  ...
                  <div class="vs-portfolio-item" style="background-color: #f3e4db">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="web-assets/images/new-portfolio/TangoPay -Fintech App.png" alt="demand-grocery-img"
                            class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img src="web-assets/images/new-portfolio/logo/TangoPay -Fintech App.png"
                                  alt="app-logo" class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                                  <span>TangoPay -Fintech App</span>
                                </h3>
                              </div>
                            </div>
                            <p class="vs-portfolio-heading-desccription">
                              TagnoPay mobile app revolutionizes how you
                              manage your money, offering secure,
                              lightning-fast payments, transfers, and bill
                              payments all in one place. With Tangopay, the
                              transactions are protected by state-of-the-art
                              security measures. Experience the future of
                              banking at your fingertips with an app like
                              TangoPay.
                            </p>
                            ...
                            <div class="vs-portfolio-footer">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://play.google.com/store/apps/details?id=com.org.TangoPay&amp;hl=en_IN&amp;gl=US"
                                  class="vs-portfolio-footer-link" target="_blank">
                                  <svg width="136" height="41" viewBox="0 0 136 41" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_5730_20582)">
                              ...
                              <div class="vs-portfolio-footer-item">
                                <a href="https://apps.apple.com/pk/app/tangopay-send-money-globally/id1590358558"
                                  class="vs-portfolio-footer-link" target="_blank">
                                  <svg width="121" height="41" viewBox="0 0 121 41" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_5730_20583)">
                        ...
                        <div class="vs-related-card">
                            <div class="vs-related-card-icon">
                                <svg width="64" height="64" viewBox="0 0 64 64" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <mask id="mask0_5996_34160" style="mask-type:luminance" maskUnits="userSpaceOnUse"
                                    ...
                                    <mask id="mask1_5996_34160" style="mask-type:luminance" maskUnits="userSpaceOnUse"
                                        x="6" y="0" width="52" height="64">
                                        <path
                                            d="M57.6827 29.5321L40.4551 46.7658L57.6827 63.9995H37.9967L20.763 46.7658L37.9967 29.5321H57.6827ZM37.9967 0L6 31.9967L15.8461 41.8427L57.6827 0H37.9967Z"
                                            fill="white" />
                                    ...
                                    <mask id="mask2_5996_34160" style="mask-type:luminance" maskUnits="userSpaceOnUse"
                                        x="6" y="0" width="52" height="64">
                                        <path
                                            d="M57.6827 29.5321L40.4551 46.7658L57.6827 63.9995H37.9967L20.763 46.7658L37.9967 29.5321H57.6827ZM37.9967 0L6 31.9967L15.8461 41.8427L57.6827 0H37.9967Z"
                                            fill="white" />
                                    ...
                                    <mask id="mask3_5996_34160" style="mask-type:luminance" maskUnits="userSpaceOnUse"
                                        x="6" y="0" width="52" height="64">
                                        <path
                                            d="M57.6827 29.5321L40.4551 46.7658L57.6827 63.9995H37.9967L20.763 46.7658L37.9967 29.5321H57.6827ZM37.9967 0L6 31.9967L15.8461 41.8427L57.6827 0H37.9967Z"
                                            fill="white" />
                                    ...
                                    <mask id="mask4_5996_34160" style="mask-type:luminance" maskUnits="userSpaceOnUse"
                                        x="6" y="0" width="52" height="64">
                                        <path
                                            d="M57.6827 29.5321L40.4551 46.7658L57.6827 63.9995H37.9967L20.763 46.7658L37.9967 29.5321H57.6827ZM37.9967 0L6 31.9967L15.8461 41.8427L57.6827 0H37.9967Z"
                                            fill="white" />
                                    ...
                                    <path
                                        ...
                                        fill="url(#paint1_radial_5996_34160)" />
                                    <defs>
                                        <linearGradient id="paint0_linear_5996_34160" x1="33.4828" y1="58.5118"
                                            x2="40.8159" y2="51.1787" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#1A237E" stop-opacity="0.4" />
                                            <stop offset="1" stop-color="#1A237E" stop-opacity="0" />
                                        </linearGradient>
                                        <radialGradient id="paint1_radial_5996_34160" cx="0" cy="0" r="1"
                                            gradientUnits="userSpaceOnUse"
                                            gradientTransform="translate(7.45194 4.36202) scale(78.2956)">
                                            <stop stop-color="white" stop-opacity="0.1" />
                                            <stop offset="1" stop-color="white" stop-opacity="0" />
                            ...
                            <div class="vs-related-card-body">
                                <h2 class="vs-related-card-title">Flutter App <br />Development</h2>
                                <p class="vs-related-card-description">Build smoothly functioning, next-gen apps with
                                    features like Hot Reloads and Ahead of Time compilations that are fully customizable
                                    and backed by the robust support without the need for a JavaScript bridge</p>
                            </div>
                        </div>
                    </div> -->
        </div>
          ...
          <div class="accordion" id="tyFaq">
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq1">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFaq1"
                  ...
                  What is AR/VR development, and how can it benefit my
                  business?
                </button>
              </h2>
              <div id="collapseFaq1" class="accordion-collapse collapse show" aria-labelledby="headingFaq1"
                ...
                <div class="accordion-body">
                  <p>
                    ...
                    development involves creating immersive experiences using
                    computer-generated environments. It benefits businesses by
                    enhancing user engagement, providing interactive training,
                    enabling virtual product demonstrations, and improving
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq2">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  What industries can benefit from AR/VR development services?
                </button>
              </h2>
              <div id="collapseFaq2" class="accordion-collapse collapse" aria-labelledby="headingFaq2"
                ...
                <div class="accordion-body">
                  <p>
                    AR/VR development is versatile and can benefit various
                    industries, including gaming, education, healthcare, real
                    estate, retail, automotive, tourism, and more. It allows
                    for innovative solutions like virtual tours, medical
                    simulations, educational games, and virtual showrooms.
                  </p>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq4">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  Can you tailor AR/VR experiences to match our specific
              ...
              <div id="collapseFaq3" class="accordion-collapse collapse" aria-labelledby="headingFaq3"
                ...
                <div class="accordion-body">
                  <p>
                    ...
                    awareness, user engagement, and customer satisfaction.
                  </p>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq4">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  What technology and platforms do you use for AR/VR
                  development?
                </button>
              </h2>
              <div id="collapseFaq4" class="accordion-collapse collapse" aria-labelledby="headingFaq4"
                ...
                <div class="accordion-body">
                  <p>
                    We use cutting-edge technologies and platforms like Unity,
                    Unreal Engine, ARKit, ARCore, and WebVR to develop
                    high-quality AR/VR applications. Our experienced
                    developers utilize these tools to create seamless,
                    immersive experiences for various devices, including
                    smartphones, VR headsets, and AR glasses.
                  </p>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq4">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  How long does it typically take to develop an AR/VR
                  application, and what is the cost involved?
                </button>
              </h2>
              <div id="collapseFaq5" class="accordion-collapse collapse" aria-labelledby="headingFaq5"
                ...
                <div class="accordion-body">
                  <p>
                    The development timeline and cost vary based on the
                    complexity of the AR/VR application, the features
                    required, and the level of customization. We provide
                    detailed project timelines and cost estimates after
                    understanding your project requirements during the
                    consultation phase, ensuring transparency and alignment
            ...
            <div class="accordion-item">
              ...
              <div id="collapseFaq6" class="accordion-collapse collapse" aria-labelledby="headingFaq6"
                ...
                <div class="accordion-body">
                  <p>
                    We bring a solid history of delivering effective AR/VR
                    development solutions. We have a team of dedicated
                    developers and AR/VR specialists who are dedicated to
                    upholding high standards of quality. We offer
                    comprehensive services, spanning from initial concept
                    development to seamless deployment, guaranteeing you a
                    tailored and streamlined solution.
                  </p>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq7">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  Do You Offer Custom AR/VR Solutions?
                </button>
              </h2>
              <div id="collapseFaq7" class="accordion-collapse collapse" aria-labelledby="headingFaq7"
                ...
                <div class="accordion-body">
                  <p>
                    ...
                    and custom AR/VR development solutions.
                  </p>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq8">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  What is The Cost of AR/VR Development?
                </button>
              </h2>
              <div id="collapseFaq8" class="accordion-collapse collapse" aria-labelledby="headingFaq8"
                ...
                <div class="accordion-body">
                  <p>
                    Costs depend on project scope and complexity. We offer
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq9">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  Can You Help with Concept Development & AR/VR App Design?
                </button>
              </h2>
              <div id="collapseFaq9" class="accordion-collapse collapse" aria-labelledby="headingFaq9"
                ...
                <div class="accordion-body">
                  <p>
                    Yes, our services include concept ideation, design, and
                    prototyping to bring your AR/VR project to life. So,
                    whether you want secure development or creative AR/VR app
                    design, we can do it all. Feel free to share your
            ...
            <div class="accordion-item">
              ...
              <div id="collapseFaq10" class="accordion-collapse collapse" aria-labelledby="headingFaq10"
                ...
                <div class="accordion-body">
                  <p>
                    We have a highly experienced team, a commitment to
                    innovation, and a track record of delivering high-quality
                    AR/VR solutions. So, feel free to connect with us for
                    profit-driven AR/VR development solutions.
                  </p>
                </div>
              </div>
            </div>
