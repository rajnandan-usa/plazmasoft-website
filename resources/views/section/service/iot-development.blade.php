...
@section('mainBody')
    ...
    <!-- ======= Hero Section ======= -->
    <section class="ar-vr-hero iot-hero pt-0 vs-hiring-landing-section">
      <div class="container">
          ...
          <div class="col-lg-6 mb-5 mb-lg-0">
            ...
            <div class="ar-vr-banner--sub-text">
              <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#requestProposalModal"
                class="cta mt-3 d-inline-block">Request a Quote</a>
              <!-- <p class="mt-4 banner-dis"><b>*No Spam. 100% Privacy Guaranteed.</b></p> -->
            </div>
          </div>
          <div class="col-lg-6">
            <div class="iot-banner">
              <img class="img-fluid" src="{{asset('web-assets/images/iot-banner-image.png')}}" alt="iot app development" />
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- End Hero -->
    <section class="description-block" data-aos="fade-up" data-aos-delay="100">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
    ...
    <section class="how-we-implement iot">
      <div class="container">
        <div class="vs-heading-center">
          ...
          <p class="vs-section-description">
            We have been involved in IoT development since early days. We
            understand the wide spectrum of IoT industry and challenges during
            the development and testing and considering that we provide our
            IoT development services to our clients and help them build secure
            and scalable IoT solutions.
          </p>
        </div>
        <div class="how-we-wrapper">
          <ul class="implement-timeline">
            <li>
              <img src="{{asset('web-assets/images/iot/discovery.svg')}}" alt="discovery" />
              <p>Problem Statement & Business objective</p>
            </li>
            <li>
              <img src="{{asset('web-assets/images/iot/idea.svg')}}" alt="idea" />
              <p>Solution & IoT Execution Strategy</p>
            </li>

            <li>
              <img src="{{asset('web-assets/images/iot/hardware-analysis.svg')}}" alt="analysis" />
              <p>Hardware Analysis & Finalization</p>
            </li>
            <li>
              <img src="{{asset('web-assets/images/iot/development.svg')}}" alt="development process" />
              <p>POC Development</p>
            </li>
            <li>
              <img src="{{asset('web-assets/images/iot/full-fledge-dev.svg')}}" alt="full fledge development" />
              <p>Web Development</p>
            </li>
            <li>
              <img src="{{asset('web-assets/images/iot/test.svg')}}" alt="test" />
              <p>Real Time testing</p>
            </li>
            <li>
              <img src="{{asset('web-assets/images/iot/launch.svg')}}" alt="launch" />
        ...
        <div class="vs-service-content mb-0">
          <div class="row">
              ...
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  ...
                  <p class="vs-service-card-description">
                    We provide IoT consulting services to help organizations
                    define their IoT strategy, assess their IoT needs, and
                    plan the implementation of IoT solutions.
                  </p>
                </a>
              </div>
            </div>
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  ...
                  <p class="vs-service-card-description">
                    We offer mobile applications for smartphones and tablets
                    that provide users with a convenient interface to control
              ...
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  ...
                  <p class="vs-service-card-description">
                    ...
                    ensure that IoT applications and devices continue to
            ...
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  <h3 class="vs-service-card-title">IoT App Integration</h3>
                  <div class="vs-service-card-logo-list">
                    <div class="vs-service-card-logo-item">
                      <svg width="36" height="37" viewBox="0 0 36 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                  ...
                  <p class="vs-service-card-description">
                    Our IoT app integration services connect IoT devices and
                    platforms to create seamless ecosystems. We enable data
                    sharing, automation, and control, facilitating smart home
                    systems, industrial monitoring, and more.
                  </p>
                </a>
              </div>
            </div>
      ...
      <div class="container">
        <div class="vs-heading-center w-100">
          ...
          <p class="vs-section-description w-75 m-auto">
            We always focus on delivering quality IoT app development
            solutions. Also, we offer reasonable solutions to develop IoT
            apps. Here is a glimpse of our pocket-friendly IoT app development
            models.
          </p>
        </div>
          ...
          <div class="row">
              ...
              <div class="vs-everyone-card">
                ...
                <div class="vs-everyone-card-body">
                  <p class="vs-everyone-description">
                    ...
                    specific set of IoT app development project.
                  </p>
            ...
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-everyone-card">
                ...
                <div class="vs-everyone-card-body">
                  <p class="vs-everyone-description">
                    Hire dedicated IoT app developers who can help you create
                    an IoT-based application.
                  </p>
                  <ul class="vs-everyone-feature-list list-unstyled">
                    <li class="vs-everyone-feature-item">
                      <span class="vs-everyone-feature-icon">
            ...
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-everyone-card">
                ...
                <div class="vs-everyone-card-body">
                  <p class="vs-everyone-description">
                    Get a white label IoT app development solution and be
    ...
    <!-- ======= platform and technology Section ======= -->
    <section class="platform-and-technology-expertise">
      <div class="container">
        <div class="vs-heading-center">
          <h2 class="vs-section-title vs-title-border">
          ...
          <p class="vs-section-description">
            Our IoT development team has in-depth knowledge of following IoT
            platforms and Protocols.
          </p>
        </div>
        <div class="technology-expertise">
          <div class="row">
            <div class="col-lg-4 col-md-6" data-aos="fade-in" data-aos-delay="100">
              <div class="expertise-wrapper">
                <div class="media">
                  <img src="{{asset('web-assets/images/iot/iot-platform.svg')}}" class="" />
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-in" data-aos-delay="200">
              <div class="expertise-wrapper">
                <div class="media">
                  <img src="{{asset('web-assets/images/iot/dev-framework.svg')}}" class="" />
                  <div class="media-body">
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-in" data-aos-delay="300">
              <div class="expertise-wrapper">
                <div class="media">
                  <img src="{{asset('web-assets/images/iot/connectivity.svg')}}" class="" />
                  <div class="media-body">
                    <h4>Connectivity</h4>
                    <ul>
                      <li>WiFi</li>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-in" data-aos-delay="400">
              <div class="expertise-wrapper">
                <div class="media">
                  <img src="{{asset('web-assets/images/iot/sensors.svg')}}" class="" />
                  <div class="media-body">
                    <h4>Sensors</h4>
                    <ul>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-in" data-aos-delay="500">
              <div class="expertise-wrapper">
                <div class="media">
                  <img src="{{asset('web-assets/images/iot/connectivity.svg')}}" class="" />
                  <div class="media-body">
                    <h4>Third Party API’s</h4>
                    <ul>
              ...
              <div class="vs-why-choose-content__inner">
                <div class="vs-why-choose-description">
                  <p>
                    ...
                    insights for your business. We prioritize security,
                    scalability, and seamless integration, ensuring a
                    future-ready IoT ecosystem. Partner with us to unlock the
                    potential of IoT and stay ahead in a rapidly evolving
              ...
              <div class="vs-why-choose-card-content">
                <div class="vs-why-choose-card-list" data-scrollbar>
                  <div class="vs-why-choose-card-item">
                    <div class="vs-why-choose-card">
                      ...
                      <p class="vs-why-choose-card-desription">
                        Our team comprises specialized IoT app developers with
                        extensive experience. We possess advanced skills that
                        can effortlessly transform your visionary project into
                        an IoT-enabled app.
                      </p>
                    </div>
                  </div>
                  <div class="vs-why-choose-card-item">
                    <div class="vs-why-choose-card">
                      <h3 class="vs-why-choose-card-title">
                        IoT Expertise and Experience:
                      </h3>
                      <p class="vs-why-choose-card-desription">
                        Our IoT development team possesses specialized
                        expertise and extensive experience in developing an
                        IoT-enabled app. To date, we have successfully
                        delivered IoT projects across various industries.
                      </p>
                    </div>
                  </div>
                  <div class="vs-why-choose-card-item">
                    <div class="vs-why-choose-card">
                      ...
                      <p class="vs-why-choose-card-desription">
                        We provide end-to-end IoT development solutions, from
                        hardware and firmware development to cloud integration
                        and data analytics. Our team ensures a holistic
                        approach to your IoT project.
                      </p>
                    </div>
                  </div>
                  <div class="vs-why-choose-card-item">
                  ...
                  <div class="vs-why-choose-card-item">
                    <div class="vs-why-choose-card">
                      ...
                      <p class="vs-why-choose-card-desription">
                        Utilizing Agile methodologies, we ensure flexibility
                        and adaptability throughout the IoT development
                        process, enabling quick iterations, timely feedback
                        incorporation, and efficient project delivery.
                      </p>
                    </div>
                  </div>
                  <div class="vs-why-choose-card-item">
                    <div class="vs-why-choose-card">
                      ...
                      <p class="vs-why-choose-card-desription">
                        We offer cost-effective IoT development solutions,
                        ensuring that your investment yields a high return on
                        investment (ROI) by delivering tangible business value
                  ...
                  <div class="vs-why-choose-card-item">
                    <div class="vs-why-choose-card">
                      ...
                      <p class="vs-why-choose-card-desription">
                        We establish a collaborative and long-term partnership
                        with our clients, providing continuous support,
                        updates, and maintenance to ensure the longevity and
                        success of your IoT projects.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="vs-portfolio-slider">
                          ...
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img
                                  src="{{asset('web-assets/images/new-portfolio/logo/7 NOW – Food &amp; Alcohol Delivery App.png')}}"
                  ...
                  <div class="vs-portfolio-item" style="background-color: #f8bbff">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="{{asset('web-assets/images/new-portfolio/Booster Rewards - (Reward App).png')}}"
                            alt="demand-grocery-img" class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img src="{{asset('web-assets/images/new-portfolio/logo/Booster Rewards - (Reward App).png')}}"
                                  alt="app-logo" class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                  ...
                  <div class="vs-portfolio-item" style="background-color: #ffd5d9">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="{{asset('web-assets/images/new-portfolio/Cloud Menu Web App.png')}}" alt="demand-grocery-img"
                            class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img src="{{asset('web-assets/images/new-portfolio/logo/Cloud Menu Web App.png')}}" alt="app-logo"
                                  class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                            ...
                            <div class="vs-portfolio-body">
                              <div class="vs-portfolio-info">
                                <div class="vs-portfolio-info-item">
                                  ...
                                  <p class="vs-portfolio-info-text vs-portfolio-info-region">
                                    <img style="padding-right: 10px" width="25%"
                                      src="{{asset('web-assets/images/new-portfolio/flags/small/Saudi Arabia.png')}}" alt="app-logo"
                                      class="img-fluid" />
                  ...
                  <div class="vs-portfolio-item" style="background-color: #e4deff">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="{{asset('web-assets/images/new-portfolio/Doos Karting App.png')}}" alt="demand-grocery-img"
                            class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img src="{{asset('web-assets/images/new-portfolio/logo/Doos Karting App.png')}}" alt="app-logo"
                                  class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                  ...
                  <div class="vs-portfolio-item" style="background-color: #ffdbec">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="{{asset('web-assets/images/new-portfolio/Ginga - Fantasy App.png')}}" alt="demand-grocery-img"
                            class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img src="{{asset('web-assets/images/new-portfolio/logo/Ginga - Fantasy App.png')}}" alt="app-logo"
                                  class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                            ...
                            <div class="vs-portfolio-body">
                              <div class="vs-portfolio-info">
                                <div class="vs-portfolio-info-item">
                                  ...
                                  <p class="vs-portfolio-info-text vs-portfolio-info-region">
                                    <img style="padding-right: 10px" width="25%"
                                      src="{{asset('web-assets/images/new-portfolio/flags/small/Malaysia.png')}}" alt="app-logo"
                                      class="img-fluid" />
                                    <span>Malaysia</span>
                                  </p>
                                </div>
                              ...
                              <div class="vs-portfolio-info">
                                <div class="vs-portfolio-info-item">
                                  ...
                                  <p class="vs-portfolio-info-text vs-portfolio-info-region">
                                    <img style="padding-right: 10px" width="25%"
                                      src="{{asset('web-assets/images/new-portfolio/flags/small/India.png')}}" alt="app-logo"
                                      class="img-fluid" />                                    <span>India</span>
                                  </p>
                                </div>
                                <div class="vs-portfolio-info-item">
                                  <label class="vs-portfolio-info-label">Duration</label>
                            ...
                            <div class="vs-portfolio-body">
                              <div class="vs-portfolio-info">
                                <div class="vs-portfolio-info-item">
                                  ...
                                  <p class="vs-portfolio-info-text vs-portfolio-info-region">
                                    <img style="padding-right: 10px" width="25%"
                                      src="{{asset('web-assets/images/new-portfolio/flags/small/UAE.png')}}" alt="app-logo"
                                      class="img-fluid" />
                                    <span>UAE</span>
                                  </p>
                                </div>
                        ...
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img
                                  src="{{asset('web-assets/images/new-portfolio/logo/Just Market Trading - Online Trading App.png')}}"
                                  alt="app-logo" class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                  ...
                  <div class="vs-portfolio-item" style="background-color: #fee1db">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="{{asset('web-assets/images/new-portfolio/Kidzin - Shopping App.png')}}" alt="demand-grocery-img"
                            class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
                        <div class="vs-portfolio-details">
                          <div class="vs-portfolio-heading">
                            <div class="vs-portfolio-heading-top">
                              <div class="vs-portfolio-logo">
                                <img src="{{asset('web-assets/images/new-portfolio/logo/Kidzin - Shopping App.png')}}" alt="app-logo"
                                  class="img-fluid" />
                              </div>
                              <div class="vs-portfolio-heading__inner">
                                <h3 class="vs-portfolio-title">
                  ...
                  <div class="vs-portfolio-item" style="background-color: #a6efff">
                    <div class="row">
                      <div class="col col-12 col-md-4 col-lg-4">
                        <div class="vs-portfolio-item-img">
                          <img src="{{asset('web-assets/images/new-portfolio/MFine - Healthcare App.png')}}" alt="demand-grocery-img"
                            class="img-fluid" />
                        </div>
                      </div>
                      <div class="col col-12 col-md-8 col-lg-8 col-xl-6 mx-auto">
          ...
          <div class="accordion" id="tyFaq">
            <div class="accordion-item">
              ...
              <div id="collapseFaq1" class="accordion-collapse collapse show" aria-labelledby="headingFaq1"
                ...
                <div class="accordion-body">
                  <p>
                    IoT development refers to the process of creating and
                    integrating smart devices, sensors, and systems that
                    communicate with each other over the Internet. IoT devices
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq2">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  What programming languages are commonly used in IoT
                  development?
                </button>
              </h2>
              <div id="collapseFaq2" class="accordion-collapse collapse" aria-labelledby="headingFaq2"
                ...
                <div class="accordion-body">
                  <p>
                    Commonly used programming languages for IoT development
                    include C, C++, Python, JavaScript, and Java, depending on
                    the specific requirements and platform.
                  </p>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq3">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  How does IoT benefit businesses and industries?
                </button>
              </h2>
              <div id="collapseFaq3" class="accordion-collapse collapse" aria-labelledby="headingFaq3"
                ...
                <div class="accordion-body">
                  <p>
                    IoT offers benefits such as improved operational
                    efficiency, real-time monitoring and insights, cost
                    savings through automation, and enhanced safety and
                    security. IoT-based applications possess the ability to
                    make data-driven decisions. Get your IoT-based application
                    today.
                  </p>
                </div>
              </div>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq4">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  What are some key components of an IoT solution?
                </button>
              </h2>
              <div id="collapseFaq4" class="accordion-collapse collapse" aria-labelledby="headingFaq4"
                ...
                <div class="accordion-body">
                  <p>
                    An IoT solution typically comprises devices or sensors,
                    connectivity, data processing and analytics, and a user
                    interface or application that allows users to interact
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq5">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  Is security a concern in IoT development, and how is it
                  addressed?
                </button>
              </h2>
              <div id="collapseFaq5" class="accordion-collapse collapse" aria-labelledby="headingFaq5"
                ...
                <div class="accordion-body">
                  <p>
                    Yes, security is a significant concern in IoT development.
                    Developers employ various measures like encryption,
                    authentication, access controls, and regular security
                    updates to protect IoT devices and the data they handle
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq6">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  How Can I Get Started With An IoT App Development Project
                  With Your Company?
                </button>
              </h2>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq7">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  Do You Offer Ongoing Support And Maintenance for IoT
                  Applications?
                </button>
              </h2>
              <div id="collapseFaq7" class="accordion-collapse collapse" aria-labelledby="headingFaq7"
                ...
                <div class="accordion-body">
                  <p>
                    ...
                    to ensure your IoT applications remain secure, up-to-date,
                    and optimized for performance. Seek industry-best mobile
                    app support and maintenance services from us today.
                  </p>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              ...
              <div id="collapseFaq8" class="accordion-collapse collapse" aria-labelledby="headingFaq8"
                ...
                <div class="accordion-body">
                  <p>
                    Security is a top priority for us. We employ industry best
                    practices to secure IoT applications and devices,
                    including encryption, authentication, access control, and
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq9">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  Do You Provide Custom IoT App Development Services?
                </button>
              </h2>
              <div id="collapseFaq9" class="accordion-collapse collapse" aria-labelledby="headingFaq9"
                ...
                <div class="accordion-body">
                  <p>
                    Yes, we specialize in custom IoT app development. Our
                    company works closely with clients to understand their
                    unique requirements and create tailored solutions to meet
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq10">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  How to Hire the Best IoT App Developers?
                </button>
              </h2>
    ...
    <section class="vs-want-discuss-section vs-section-spacer">
      <div class="container">
        <div class="vs-heading-center">
          <h2 class="vs-section-title vs-title-border">
            Drop Your IoT App Development Idea Here!
          </h2>
          <p class="vs-section-description">
