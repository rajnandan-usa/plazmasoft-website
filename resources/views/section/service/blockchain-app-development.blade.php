...
@section('mainBody')
        ...
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="ios-banner">
              <img class="img-fluid" src="web-assets/images/block-chain-hero.png" alt="blockchain app developement" />
            </div>
          </div>
          <div class="col-lg-6 mb-5 mb-lg-0" data-aos="fade-in" data-aos-delay="100">
            ...
            <div class="ar-vr-banner--sub-text">
              ...
              <p class="mt-4 banner-dis">
                <b>*No Spam. 100% Privacy Guaranteed.</b>
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="vs-heading-center">
          <h2 class="vs-section-title vs-title-border">
            Top-notch Blockchain App Development Services
          </h2>
        ...
        <div class="vs-service-content mb-0">
          <div class="row">
                ...
                <a href="#" class="vs-service-card-link">
                  ...
                  <div class="vs-service-card-logo-list">
                    <div class="vs-service-card-logo-item">
                      <img src="web-assets/images/tech-consultant.svg" width="30px" height="30px" />
                    </div>
                  </div>
                  <p class="vs-service-card-description">
                    The goal of blockchain consulting is to translate business
                    targets into technology roadmaps that clients can follow
            ...
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  ...
                  <div class="vs-service-card-logo-list">
                    <div class="vs-service-card-logo-item">
                      <img src="web-assets/images/crypto-wallet.svg" width="30px" height="30px" />
                    </div>
                  </div>
                  <p class="vs-service-card-description">
                    Crypto wallets function like a traditional wallet, but
                    instead of regular paper currency, it holds proof of your
                    crypto/digital cash, which contains private and public
                    keys of wallet.
                  </p>
                </a>
              </div>
            ...
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  <h3 class="vs-service-card-title">DApp Development</h3>
                  <div class="vs-service-card-logo-list">
                    <div class="vs-service-card-logo-item">
                      <img src="web-assets/images/daapp-dev.svg" width="30px" height="30px" />
                    </div>
                  </div>
                  <p class="vs-service-card-description">
                    DApps is a computer application or program that exists and
                    runs on a decentralized network of computers and not a
                    centralized server.
                  </p>
                </a>
              </div>
            ...
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  ...
                  <div class="vs-service-card-logo-list">
                    <div class="vs-service-card-logo-item">
                      <img src="web-assets/images/crypto-exchange.svg" width="30px" height="30px" />
                    </div>
                  </div>
                  <p class="vs-service-card-description">
                    We provide secured and hack-proof Crypto Exchange
                    development solutions for multiple crypto currencies
                    exchanging , buying and selling for different blockchain
                    platforms.
                  </p>
                </a>
              </div>
            ...
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  ...
                  <div class="vs-service-card-logo-list">
                    <div class="vs-service-card-logo-item">
                      <img src="web-assets/images/ico-dev.svg" width="30px" height="30px" />
                    </div>
                  </div>
                  <p class="vs-service-card-description">
                    ICO is a mechanism with the help of funds raised for a
                    newly launched cryptocurrency offering. It is quite
                    similar to IPO (Initial Public Offerings) when a company
                    is registered in stock exchange.
                  </p>
                </a>
              </div>
            </div>
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  <h3 class="vs-service-card-title">White paper writing</h3>
                  <div class="vs-service-card-logo-list">
                    <div class="vs-service-card-logo-item">
                      <img src="web-assets/images/white-paper.svg" width="30px" height="30px" />
                    </div>
                  </div>
                  <p class="vs-service-card-description">
                    We deliver white paper writing services that deliver
                    comprehensive, well-researched documents on blockchain,
                    providing in-depth insights and project analysis.
                  </p>
                </a>
              </div>
            </div>
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  <h3 class="vs-service-card-title">Token Development</h3>
                  <div class="vs-service-card-logo-list">
                    <div class="vs-service-card-logo-item">
                      <img src="web-assets/images/token-dev.svg" width="30px" height="30px" />
                    </div>
                  </div>
                  <p class="vs-service-card-description">
                    Our Token development services encompass creating digital
                    tokens on various blockchain platforms. Our experts
                    facilitate functionalities, including fundraising voting
            ...
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  ...
                  <div class="vs-service-card-logo-list">
                    <div class="vs-service-card-logo-item">
                      <img src="web-assets/images/smart-contract.svg" width="30px" height="30px" />
                    </div>
                  </div>
                  <p class="vs-service-card-description">
                    With our smart contract development, you can get
                    self-executing contracts with predefined rules and
                    conditions. Get ready to automate processes on the
                    blockchain, ensuring transparency, security, and trust.
                  </p>
                </a>
              </div>
            </div>
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-service-card">
                <a href="#" class="vs-service-card-link">
                  ...
                  <div class="vs-service-card-logo-list">
                    <div class="vs-service-card-logo-item">
                      <img src="web-assets/images/admin-panel.svg" width="30px" height="30px" />
                    </div>
                  </div>
                  <p class="vs-service-card-description">
                    Our admin panel development focuses on designing
                    intuitive, centralized interfaces for managing and
                    controlling applications. Ensure efficient monitoring,
                    content management, and user administration with us.
                  </p>
                </a>
              </div>
            </div>
          ...
          <div class="row">
              ...
              <div class="vs-everyone-card">
                ...
                <div class="vs-everyone-card-body">
                  <p class="vs-everyone-description">
                    ...
                    specific set of blockchain app development project.
                  </p>
            ...
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-everyone-card">
                ...
                <div class="vs-everyone-card-body">
                  <p class="vs-everyone-description">
                    Hire dedicated blockchain app developers who can help you
            ...
            <div class="col col-12 col-md-6 col-lg-4">
              <div class="vs-everyone-card">
                ...
                <div class="vs-everyone-card-body">
                  <p class="vs-everyone-description">
                    Get a white label blockchain app development solution and
                    be ready to outshine this competitive market.
                  </p>
                  <ul class="vs-everyone-feature-list list-unstyled">
                    <li class="vs-everyone-feature-item">
                      <span class="vs-everyone-feature-icon">
              ...
              <div class="vs-why-choose-content__inner">
                <div class="vs-why-choose-description">
                  <p>
                    ...
                    projects, ensuring the growth and efficiency of your
                    enterprise in the dynamic realm of decentralized
                    solutions. Elevate your business with our blockchain
                    solutions that empower you to thrive in the digital age.
                  </p>
                </div>
                ...
                <div class="vs-why-choose-card-list" data-scrollbar>
                  <div class="vs-why-choose-card-item">
                    <div class="vs-why-choose-card">
                      ...
                      <p class="vs-why-choose-card-desription">
                        Our dedicated team comprises highly specialized
                        blockchain app developers. We possess advanced skills
                        that can seamlessly translate your visionary project
                        into a fully functional blockchain app.
                      </p>
                    </div>
                  </div>
                  <div class="vs-why-choose-card-item">
                    <div class="vs-why-choose-card">
                      ...
                      <p class="vs-why-choose-card-desription">
                        Our blockchain app development team holds expertise in
                        crafting blockchain-powered applications. Over time,
                        we have successfully delivered blockchain projects
                  ...
                  <div class="vs-why-choose-card-item">
                    <div class="vs-why-choose-card">
                      ...
                      <p class="vs-why-choose-card-desription">
                        We offer end-to-end app development solutions while
                        leveraging all the latest tools and technologies,
                        including blockchain. Our approach ensures a holistic
                        treatment of your blockchain project.
                      </p>
                    </div>
                  </div>
                  <div class="vs-why-choose-card-item">
                  ...
                  <div class="vs-why-choose-card-item">
                    <div class="vs-why-choose-card">
                      ...
                      <p class="vs-why-choose-card-desription">
                        By employing Agile methodologies, we infuse
                        flexibility and adaptability into the blockchain
                        development process. This approach facilitates timely
                        feedback incorporation and efficient project delivery.
                      </p>
                    </div>
                  </div>
                  <div class="vs-why-choose-card-item">
                    <div class="vs-why-choose-card">
                      ...
                      <p class="vs-why-choose-card-desription">
                        We prioritize cost-effective blockchain development
                        solutions to ensure that your investment results in a
                        high ROI. Our focus is on delivering tangible business
    ...
    <section class="vs-want-discuss-section vs-section-spacer">
      <div class="container">
        <div class="vs-heading-center">
          <h2 class="vs-section-title vs-title-border">
            Share Your Requirements for Blockchain App Development!
          </h2>
          <p class="vs-section-description">
        ...
        <div class="text-center">
          <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#requestProposalModal"
            class="btn btn-outline-light">Book A Consultation</a>
        </div>
      </div>
    </section>
          ...
          <div class="accordion" id="tyFaq">
            <div class="accordion-item">
              ...
              <div id="collapseFaq1" class="accordion-collapse collapse show" aria-labelledby="headingFaq1"
                ...
                <div class="accordion-body">
                  <p>
                    Blockchain app development involves creating applications
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq2">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  Why is blockchain technology important for app development?
                </button>
              </h2>
              <div id="collapseFaq2" class="accordion-collapse collapse" aria-labelledby="headingFaq2"
                ...
                <div class="accordion-body">
                  <p>
                    Blockchain ensures transparency, security, and trust by
                    providing a tamper-proof and distributed ledger.
                    Blockchain technology is vital for various applications,
                    including financial, healthcare, and supply chains.
                  </p>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq3">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  What are the key features of a blockchain-based app?
                </button>
              </h2>
              <div id="collapseFaq3" class="accordion-collapse collapse" aria-labelledby="headingFaq3"
                ...
                <div class="accordion-body">
                  <p>
                    Key features include decentralization, immutability,
                    security, transparency, smart contract functionality, and
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq4">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  What programming languages are commonly used for blockchain
                  app development?
                </button>
              </h2>
              <div id="collapseFaq4" class="accordion-collapse collapse" aria-labelledby="headingFaq4"
                ...
                <div class="accordion-body">
                  <p>
                    Common languages include Solidity, JavaScript, Python, and
                    C++. Solidity is often used for developing smart contracts
            ...
            <div class="accordion-item">
              ...
              <div id="collapseFaq5" class="accordion-collapse collapse" aria-labelledby="headingFaq5"
                ...
                <div class="accordion-body">
                  <p>
                    The blockchain development time can vary based on project
                    complexity, features, and platform choice. A simple app
                    may take a few months, while more complex projects can
                    take a year or more.
                  </p>
                </div>
              </div>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq6">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  Why Should I Choose Your Company for Blockchain App
                  Development?
                </button>
              </h2>
              <div id="collapseFaq6" class="accordion-collapse collapse" aria-labelledby="headingFaq6"
                ...
                <div class="accordion-body">
                  <p>
                    ...
                    blockchain solutions. Our team comprises experienced
                    developers, blockchain experts, and a commitment to
                    quality. We provide end-to-end services, from concept to
                    deployment, ensuring you receive a customized and
                    efficient solution.
                  </p>
                </div>
              </div>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingFaq7">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  What Types of Blockchain Applications Do You Develop?
                </button>
              </h2>
              <div id="collapseFaq7" class="accordion-collapse collapse" aria-labelledby="headingFaq7"
                ...
                <div class="accordion-body">
                  <p>
                    We specialize in various blockchain applications,
                    including supply chain management, smart contracts,
                    decentralized finance (DeFi), non-fungible tokens (NFTs),
                    identity verification, and more. We tailor solutions to
            ...
            <div class="accordion-item">
              ...
              <div id="collapseFaq8" class="accordion-collapse collapse" aria-labelledby="headingFaq8"
                ...
                <div class="accordion-body">
                  <p>
                    Blockchain technology is known for its security features,
                    such as cryptographic encryption and decentralized
                    consensus. However, like any technology, security is an
                    ongoing concern. We implement best practices to ensure
                    your blockchain app is as secure as possible.
                  </p>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              ...
              <div id="collapseFaq9" class="accordion-collapse collapse" aria-labelledby="headingFaq9"
                ...
                <div class="accordion-body">
                  <p>
                    The cost of blockchain app development varies depending on
                    factors like complexity, features, and the platform used.
                    We provide customized quotes after discussing your
              ...
              <div id="collapseFaq10" class="accordion-collapse collapse" aria-labelledby="headingFaq10"
                ...
                <div class="accordion-body">
                  <p>
                    ...
                    ensure your blockchain app runs smoothly, receives
                    updates, and remains secure. We're here to help you with
