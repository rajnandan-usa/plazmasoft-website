...
return [
    ...
    */
    ...
    'after' => ':attribute फ़ील्ड की तारीख :date के बाद होनी चाहिए।',
    'after_or_equal' => ':attribute फ़ील्ड की तारीख :date के बाद या समान होनी चाहिए।',
    'alpha' => ':attribute फ़ील्ड में केवल अक्षर होने चाहिए।',
    'alpha_dash' => ':attribute फ़ील्ड में केवल अक्षर, संख्याएँ, डैश और अंडरस्कोर हो सकते हैं।',
    'alpha_num' => ':attribute फ़ील्ड में केवल अक्षर और संख्याएँ होनी चाहिए।',
    'array' => ':attribute फ़ील्ड एक एरे होना चाहिए।',
    'ascii' => ':attribute फ़ील्ड में केवल सिंगल-बाइट अल्फ़ान्यूमेरिक कैरेक्टर और सिम्बल्स होने चाहिए।',
    'before' => ':attribute फ़ील्ड की तारीख :date से पहले होनी चाहिए।',
    'before_or_equal' => ':attribute फ़ील्ड की तारीख :date से पहले या समान होनी चाहिए।',
    'between' => [
        ...
        'string' => ':attribute फ़ील्ड में :min और :max अक्षर होने चाहिए।',
    ],
    'boolean' => ':attribute फ़ील्ड का मान सत्य (true) या झूठा (false) होना चाहिए।',
    ...
    'declined' => ':attribute फ़ील्ड को अस्वीकृत किया जाना चाहिए।',
    'declined_if' => ':attribute फ़ील्ड को अस्वीकृत किया जाना चाहिए जब :other :value हो।',
    'different' => ':attribute फ़ील्ड और :other अलग-अलग होने चाहिए।',
    'digits' => ':attribute फ़ील्ड में :digits अंकों की संख्या होनी चाहिए।',
    'digits_between' => ':attribute फ़ील्ड में :min और :max अंकों की संख्या होनी चाहिए।',
    'dimensions' => ':attribute फ़ील्ड के चित्र आयाम अमान्य हैं।',
    ...
    'doesnt_start_with' => ':attribute फ़ील्ड निम्नलिखित में से किसी से प्रारंभ नहीं होना चाहिए: :values।',
    ...
    'extensions' => ':attribute फ़ील्ड में निम्नलिखित एक्सटेंशन्स में से एक होना चाहिए: :values।',
    ...
    'gt' => [
        ...
        'string' => ':attribute फ़ील्ड में :value से अधिक अक्षर होने चाहिए।',
    ],
    'gte' => [
        'array' => ':attribute फ़ील्ड में :value या अधिक आइटम होने चाहिए।',
        'file' => ':attribute फ़ील्ड का आकार :value किलोबाइट्स या उससे अधिक होना चाहिए।',
        'numeric' => ':attribute फ़ील्ड :value के बराबर या उससे अधिक होना चाहिए।',
        'string' => ':attribute फ़ील्ड में :value के बराबर या उससे अधिक अक्षर होने चाहिए।',
    ],
    ...
    'lt' => [
        ...
        'string' => ':attribute फ़ील्ड में :value से कम अक्षर होने चाहिए।',
    ],
    'lte' => [
        'array' => ':attribute फ़ील्ड में :value से अधिक आइटम नहीं होने चाहिए।',
        'file' => ':attribute फ़ील्ड का आकार :value किलोबाइट्स या उससे कम होना चाहिए।',
        'numeric' => ':attribute फ़ील्ड :value से कम या बराबर होना चाहिए।',
        'string' => ':attribute फ़ील्ड में :value से कम या बराबर अक्षर होने चाहिए।',
    ],
    ...
    'max' => [
        ...
        'string' => ':attribute फ़ील्ड में :max से अधिक अक्षर नहीं होने चाहिए।',
    ],
    ...
    'missing_unless' => ':attribute फ़ील्ड तब गायब होना चाहिए जब तक कि :other :value न हो।',
    ...
    'multiple_of' => ':attribute फ़ील्ड :value का एक गुणक होना चाहिए।',
    ...
    'password' => [
        ...
        'symbols' => ':attribute फ़ील्ड में कम से कम एक सिम्बल होना चाहिए।',
        'uncompromised' => 'दी गई :attribute एक डेटा लीक में सामने आई है। कृपया एक अलग :attribute चुनें।',
    ],
    'present' => ':attribute फ़ील्ड मौजूद होना चाहिए।',
    'present_if' => ':attribute फ़ील्ड तब मौजूद होना चाहिए जब :other :value हो।',
    'present_unless' => ':attribute फ़ील्ड तब मौजूद होना चाहिए जब तक कि :other :value न हो।',
    ...
    'prohibited_unless' => ':attribute फ़ील्ड तब प्रतिबंधित है जब तक कि :other :values में न हो।',
    'prohibits' => ':attribute फ़ील्ड :other को मौजूद होने से रोकता है।',
    'regex' => ':attribute फ़ील्ड प्रारूप अमान्य है।',
    'required' => ':attribute फ़ील्ड की आवश्यकता है।',
    'required_array_keys' => ':attribute फ़ील्ड में :values के लिए प्रविष्टियाँ होनी चाहिए।',
    'required_if' => ':attribute फ़ील्ड की आवश्यकता है जब :other :value हो।',
    'required_if_accepted' => ':attribute फ़ील्ड की आवश्यकता है जब :other स्वीकार किया गया हो।',
    'required_if_declined' => ':attribute फ़ील्ड की आवश्यकता है जब :other अस्वीकृत हो।',
    'required_unless' => ':attribute फ़ील्ड की आवश्यकता है जब तक कि :other :values में न हो।',
    'required_with' => ':attribute फ़ील्ड की आवश्यकता है जब :values मौजूद हो।',
    'required_with_all' => ':attribute फ़ील्ड की आवश्यकता है जब :values मौजूद हों।',
    'required_without' => ':attribute फ़ील्ड की आवश्यकता है जब :values मौजूद नहीं हो।',
    'required_without_all' => ':attribute फ़ील्ड की आवश्यकता है जब कोई भी :values मौजूद न हो।',
    'same' => ':attribute फ़ील्ड को :other से मेल खाना चाहिए।',
    'size' => [
    ...
    'starts_with' => ':attribute फ़ील्ड निम्नलिखित में से किसी के साथ शुरू होना चाहिए: :values।',
    ...
    'uppercase' => ':attribute फ़ील्ड को अपरकेस होना चाहिए।',
